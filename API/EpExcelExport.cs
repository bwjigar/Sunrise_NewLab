        ...
        public static void Buyer_Excel(DataTable dtDiamonds, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage p = new ExcelPackage())
                {
                    ...
                    worksheet.Cells[6, 1, 6, 70].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    worksheet.Cells[6, 1, 6, 70].Style.VerticalAlignment = ExcelVerticalAlignment.Top;
                    worksheet.Cells[6, 1, 6, 70].Style.Font.Size = 10;
                    worksheet.Cells[6, 1, 6, 70].Style.Font.Bold = true;

                    worksheet.Cells[6, 1, 6, 70].AutoFilter = true;
                    worksheet.Cells[1, 6].Style.HorizontalAlignment = ExcelHorizontalAlignment.Left;
                    worksheet.Cells[2, 6].Style.HorizontalAlignment = ExcelHorizontalAlignment.Left;
                    worksheet.Cells[3, 6].Style.HorizontalAlignment = ExcelHorizontalAlignment.Left;

                    var cellBackgroundColor1 = worksheet.Cells[6, 1, 6, 70].Style.Fill;
                    ...
                    worksheet.Cells[6, 4].Value = "Certi";
                    worksheet.Cells[6, 5].Value = "Lab";
                    worksheet.Cells[6, 6].Value = "Supplier Name";
                    worksheet.Cells[6, 7].Value = "Rank";
                    worksheet.Cells[6, 8].Value = "Supplier Status";
                    worksheet.Cells[6, 9].Value = "Buyer Name";
                    worksheet.Cells[6, 10].Value = "Status";
                    worksheet.Cells[6, 11].Value = "Supplier Stone Id";
                    worksheet.Cells[6, 12].Value = "Certificate No";
                    worksheet.Cells[6, 13].Value = "Shape";
                    worksheet.Cells[6, 14].Value = "Pointer";
                    worksheet.Cells[6, 15].Value = "Sub Pointer";
                    worksheet.Cells[6, 16].Value = "Color";
                    worksheet.Cells[6, 17].Value = "Clarity";
                    worksheet.Cells[6, 18].Value = "Cts";
                    worksheet.Cells[6, 19].Value = "Rap Rate";
                    worksheet.Cells[6, 20].Value = "Rap Amount";
                    worksheet.Cells[6, 21].Value = "Supplier Base Offer(%)";
                    worksheet.Cells[6, 22].Value = "Supplier Base Offer Value($)";
                    worksheet.Cells[6, 23].Value = "Supplier Final Disc(%)";
                    worksheet.Cells[6, 24].Value = "Supplier Final Value($)";
                    worksheet.Cells[6, 25].Value = "Supplier Final Disc. With Max Slab(%)";
                    worksheet.Cells[6, 26].Value = "Supplier Final Value With Max Slab($)";
                    worksheet.Cells[6, 27].Value = "Bid Disc(%)";
                    worksheet.Cells[6, 28].Value = "Bid Amt";
                    worksheet.Cells[6, 29].Value = "Bid/Ct";
                    worksheet.Cells[6, 30].Value = "Avg. Stock Disc(%)";
                    worksheet.Cells[6, 31].Value = "Avg. Stock Pcs";
                    worksheet.Cells[6, 32].Value = "Avg. Pur. Disc(%)";
                    worksheet.Cells[6, 33].Value = "Avg. Pur. Pcs";
                    worksheet.Cells[6, 34].Value = "Avg. Sales Disc(%)";
                    worksheet.Cells[6, 35].Value = "Sales Pcs";
                    worksheet.Cells[6, 36].Value = "KTS Grade";
                    worksheet.Cells[6, 37].Value = "Comm. Grade";
                    worksheet.Cells[6, 38].Value = "Zone";
                    worksheet.Cells[6, 39].Value = "Para. Grade";
                    worksheet.Cells[6, 40].Value = "Cut";
                    worksheet.Cells[6, 41].Value = "Polish";
                    worksheet.Cells[6, 42].Value = "Symm";
                    worksheet.Cells[6, 43].Value = "Fls";
                    worksheet.Cells[6, 44].Value = "Key To Symbol";
                    worksheet.Cells[6, 45].Value = "Ratio";
                    worksheet.Cells[6, 46].Value = "Length";
                    worksheet.Cells[6, 47].Value = "Width";
                    worksheet.Cells[6, 48].Value = "Depth";
                    worksheet.Cells[6, 49].Value = "Depth(%)";
                    worksheet.Cells[6, 50].Value = "Table(%)";
                    worksheet.Cells[6, 51].Value = "Crown Ang";
                    worksheet.Cells[6, 52].Value = "Crown Hgt";
                    worksheet.Cells[6, 53].Value = "Pavilion Ang";
                    worksheet.Cells[6, 54].Value = "Pavilion Hgt";
                    worksheet.Cells[6, 55].Value = "Girdle(%)";
                    worksheet.Cells[6, 56].Value = "Luster";
                    worksheet.Cells[6, 57].Value = "Type 2A";
                    worksheet.Cells[6, 58].Value = "Table Inclusion";
                    worksheet.Cells[6, 59].Value = "Crown Inclusion";
                    worksheet.Cells[6, 60].Value = "Table Natts";
                    worksheet.Cells[6, 61].Value = "Crown Natts";
                    worksheet.Cells[6, 62].Value = "Culet";
                    worksheet.Cells[6, 63].Value = "Lab Comments";
                    worksheet.Cells[6, 64].Value = "Supplier Comments";
                    worksheet.Cells[6, 65].Value = "Table Open";
                    worksheet.Cells[6, 66].Value = "Crown Open";
                    worksheet.Cells[6, 67].Value = "Pav Open";
                    worksheet.Cells[6, 68].Value = "Girdle Open";
                    worksheet.Cells[6, 69].Value = "Shade";
                    worksheet.Cells[6, 70].Value = "Milky";

                    ExcelStyle cellStyleHeader1 = worksheet.Cells[6, 1, 6, 70].Style;
                    ...
                    worksheet.Cells[6, 1].AutoFitColumns(5.43);                     //"Sr. No";
                    worksheet.Cells[6, 2].AutoFitColumns(9);                        //"Image";
                    worksheet.Cells[6, 3].AutoFitColumns(9);                        //"Video";
                    worksheet.Cells[6, 4].AutoFitColumns(9);                        //"Certi";
                    worksheet.Cells[6, 5].AutoFitColumns(9);                       //"Lab";
                    worksheet.Cells[6, 6].AutoFitColumns(15);                    //"Supplier Name";
                    worksheet.Cells[6, 7].AutoFitColumns(6);                     //"Rank";
                    worksheet.Cells[6, 8].AutoFitColumns(10);                     //"Supplier Status";
                    worksheet.Cells[6, 9].AutoFitColumns(15);                        //"Buyer Name";
                    worksheet.Cells[6, 10].AutoFitColumns(6);              // "Status";
                    worksheet.Cells[6, 11].AutoFitColumns(13.5);              // "Supplier Stone Id";
                    worksheet.Cells[6, 12].AutoFitColumns(13.5);                    // "Certificate No";
                    worksheet.Cells[6, 13].AutoFitColumns(9);                    // "Shape";
                    worksheet.Cells[6, 14].AutoFitColumns(8);                    // "Pointer";
                    worksheet.Cells[6, 15].AutoFitColumns(8);                    // "Sub Pointer";
                    worksheet.Cells[6, 16].AutoFitColumns(8);                    // "Color";
                    worksheet.Cells[6, 17].AutoFitColumns(8);                      // "Clarity";
                    worksheet.Cells[6, 18].AutoFitColumns(8);                      // "Cts";
                    worksheet.Cells[6, 19].AutoFitColumns(13);                   // "Rap Rate";
                    worksheet.Cells[6, 20].AutoFitColumns(13);                      // "Rap Amount";
                    worksheet.Cells[6, 21].AutoFitColumns(13);                       // "Supplier Base Offer(%)";
                    worksheet.Cells[6, 22].AutoFitColumns(13);                    // "Supplier Base Offer Value($)";
                    worksheet.Cells[6, 23].AutoFitColumns(13);                    // "Supplier Final Disc(%)";
                    worksheet.Cells[6, 24].AutoFitColumns(13);                    // "Supplier Final Value($)";
                    worksheet.Cells[6, 25].AutoFitColumns(13);                    // "Supplier Final Disc. With Max Slab(%)";
                    worksheet.Cells[6, 26].AutoFitColumns(13);                    // "Supplier Final Value With Max Slab($)";
                    worksheet.Cells[6, 27].AutoFitColumns(13);                    // "Bid Disc(%)";
                    worksheet.Cells[6, 28].AutoFitColumns(13);                    // "Bid Amt";
                    worksheet.Cells[6, 29].AutoFitColumns(13);                    // "Bid/Ct";
                    worksheet.Cells[6, 30].AutoFitColumns(13);                       // "Avg. Stock Disc(%)";
                    worksheet.Cells[6, 31].AutoFitColumns(9);                     // "Avg. Stock Pcs";
                    worksheet.Cells[6, 32].AutoFitColumns(13);                   // "Avg. Pur. Disc(%)";
                    worksheet.Cells[6, 33].AutoFitColumns(9);                      // "Avg. Pur. Pcs";
                    worksheet.Cells[6, 34].AutoFitColumns(13);                    // "Avg. Sales Disc(%)";
                    worksheet.Cells[6, 35].AutoFitColumns(9);                    // "Sales Pcs";
                    worksheet.Cells[6, 36].AutoFitColumns(7.86);                    // "KTS Grade";
                    worksheet.Cells[6, 37].AutoFitColumns(7.86);                    // "Comm. Grade";
                    worksheet.Cells[6, 38].AutoFitColumns(7.86);                    // "Zone";
                    worksheet.Cells[6, 39].AutoFitColumns(7.86);                    // "Para. Grade";
                    worksheet.Cells[6, 40].AutoFitColumns(7.86);                    // "Cut";
                    worksheet.Cells[6, 41].AutoFitColumns(7.86);                    // "Polish";
                    worksheet.Cells[6, 42].AutoFitColumns(7.86);                    // "Symm";
                    worksheet.Cells[6, 43].AutoFitColumns(7.86);                    // "Fls";
                    worksheet.Cells[6, 44].AutoFitColumns(15);                    // "Key To Symbol";
                    worksheet.Cells[6, 45].AutoFitColumns(7.86);                    // "Ratio";
                    worksheet.Cells[6, 46].AutoFitColumns(7.86);                    // "Length";
                    worksheet.Cells[6, 47].AutoFitColumns(7.86);                    // "Width";
                    worksheet.Cells[6, 48].AutoFitColumns(7.86);                    // "Depth";
                    worksheet.Cells[6, 49].AutoFitColumns(7.86);                    // "Depth(%)";
                    worksheet.Cells[6, 50].AutoFitColumns(7.86);                    // "Table(%)";
                    worksheet.Cells[6, 51].AutoFitColumns(7.86);                    // "Crown Ang";
                    worksheet.Cells[6, 52].AutoFitColumns(7.86);                    // "Crown Hgt";
                    worksheet.Cells[6, 53].AutoFitColumns(7.86);                    // "Pavilion Ang";
                    worksheet.Cells[6, 54].AutoFitColumns(7.86);                    // "Pavilion Hgt";
                    worksheet.Cells[6, 55].AutoFitColumns(7.86);                    // "Girdle(%)";
                    worksheet.Cells[6, 56].AutoFitColumns(7.86);                    // "Luster";
                    worksheet.Cells[6, 57].AutoFitColumns(7.86);                    // "Type 2A";
                    worksheet.Cells[6, 58].AutoFitColumns(7.86);                    // "Table Inclusion";
                    worksheet.Cells[6, 59].AutoFitColumns(7.86);                    // "Crown Inclusion";
                    worksheet.Cells[6, 60].AutoFitColumns(7.86);                    // "Table Natts";
                    worksheet.Cells[6, 61].AutoFitColumns(7.86);                    // "Crown Natts";
                    worksheet.Cells[6, 62].AutoFitColumns(7.86);                    // "Culet";
                    worksheet.Cells[6, 63].AutoFitColumns(15);                    // "Lab Comments";
                    worksheet.Cells[6, 64].AutoFitColumns(15);                    // "Supplier Comments";
                    worksheet.Cells[6, 65].AutoFitColumns(7.86);                    // "Table Open";
                    worksheet.Cells[6, 66].AutoFitColumns(7.86);                    // "Crown Open";
                    worksheet.Cells[6, 67].AutoFitColumns(7.86);                    // "Pav Open";
                    worksheet.Cells[6, 68].AutoFitColumns(7.86);                    // "Girdle Open";
                    worksheet.Cells[6, 69].AutoFitColumns(7.86);                    // "Shade";
                    worksheet.Cells[6, 70].AutoFitColumns(7.86);                    // "Milky";
