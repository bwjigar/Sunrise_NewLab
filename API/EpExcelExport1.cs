...
namespace API
{
    public class EpExcelExport1
    {
        public static void _Buyer_Excel(DataTable dtDiamonds, DataTable Col_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
        ...
        public static void _Supplier_Excel(DataTable dtDiamonds, DataTable Col_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage p = new ExcelPackage())
        ...
        public static void _Customer_Excel(DataTable dtDiamonds, DataTable Col_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage p = new ExcelPackage())
        ...
        public static void _Not_Mapped_SupplierStock_Excel(DataTable dtDiamonds, string suppName, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage p = new ExcelPackage())
