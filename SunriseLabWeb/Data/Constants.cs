...
namespace SunriseLabWeb_New.Data
{
    public class Constants
    {
        ...
        public static string Get_LabEntryReport = "/User/Get_LabEntryReport";
        public static string Excel_LabEntryReport = "/User/Excel_LabEntryReport";

        public static string Get_LoginDetail = "/User/Get_LoginDetail";
        public static string Excel_LoginDetail = "/User/Excel_LoginDetail";

        public static string Get_UserActivity = "/User/Get_UserActivity";
        public static string Excel_UserActivity = "/User/Excel_UserActivity";
        ...
        public static string Supplier_File_Stock_Validity_Scheduler = "/User/Supplier_File_Stock_Validity_Scheduler";
