    ...
    if (KeyToSymbolList.length > 0) {
        $.each(KeyToSymbolList, function (i, itm) {
            $('#searchkeytosymbol').append('<div class="col-12 pl-0 pr-0 ng-scope">'
                ...
                + '<div class="main-cust-check">'
                + '<label class="cust-rdi-bx mn-check">'
                + '<input type="radio" class="checkradio" id="CHK_KTS_Radio_' + itm.Value.replaceAll(" ", "_") + '" name="radio_KTS_' + itm.Value.replaceAll(" ", "_") + '" onclick="GetCheck_KTS_List(\'' + itm.Value + '\');">'
                + '<span class="cust-rdi-check">'
                + '<i class="fa fa-check"></i>'
                + '</span>'
                + '</label>'
                + '<label class="cust-rdi-bx mn-time">'
                + '<input type="radio" id="UNCHK_KTS_Radio_' + itm.Value.replaceAll(" ", "_") + '" class="checkradio" name="radio_KTS_' + itm.Value.replaceAll(" ", "_") + '" onclick="GetUnCheck_KTS_List(\'' + itm.Value + '\');">'
                + '<span class="cust-rdi-check">'
    ...
    if (RCommentList.length > 0) {
        $.each(RCommentList, function (i, itm) {
            $('#searchRComment').append('<div class="col-12 pl-0 pr-0 ng-scope">'
                ...
                + '<div class="main-cust-check">'
                + '<label class="cust-rdi-bx mn-check">'
                + '<input type="radio" class="checkradio" id="CHK_RC_Radio_' + itm.Value.replaceAll(" ", "_") + '" name="radio_RC_' + itm.Value.replaceAll(" ", "_") + '" onclick="GetCheck_RC_List(\'' + itm.Value + '\');">'
                + '<span class="cust-rdi-check">'
                + '<i class="fa fa-check"></i>'
                + '</span>'
                + '</label>'
                + '<label class="cust-rdi-bx mn-time">'
                + '<input type="radio" id="UNCHK_RC_Radio_' + itm.Value.replaceAll(" ", "_") + '" class="checkradio" name="radio_RC_' + itm.Value.replaceAll(" ", "_") + '" onclick="GetUnCheck_RC_List(\'' + itm.Value + '\');">'
                + '<span class="cust-rdi-check">'
                + '<i class="fa fa-times"></i>'
                + '</span>'
                + '</label>'
