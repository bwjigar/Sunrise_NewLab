...
namespace EpExcelExportLib
{
    public class EpExcelExport
    {
        ...
        public static void Buyer_Excel_Old(DataTable dtDiamonds, DataTable Col_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
        ...
        public static void Buyer_Excel_Old1(DataTable dtDiamonds, DataTable Col_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage p = new ExcelPackage())
                {
                    ...
                    worksheet.Cells[2, 2].AutoFitColumns(7);

                    worksheet.Cells[2, 3].Value = "Video";
                    worksheet.Cells[2, 3].AutoFitColumns(7);

                    worksheet.Cells[2, 4].Value = "Lab";
                    worksheet.Cells[2, 4].AutoFitColumns(5);

                    worksheet.Cells[2, 5].Value = "Supplier Name";
                    worksheet.Cells[2, 5].AutoFitColumns(10);

                    worksheet.Cells[2, 6].Value = "Rank";
                    worksheet.Cells[2, 6].AutoFitColumns(4.7);

                    worksheet.Cells[2, 7].Value = "Supplier Status";
                    worksheet.Cells[2, 7].AutoFitColumns(5);

                    worksheet.Cells[2, 8].Value = "Buyer Name";
                    worksheet.Cells[2, 8].AutoFitColumns(6.5);

                    worksheet.Cells[2, 9].Value = "Status";
                    worksheet.Cells[2, 9].AutoFitColumns(7);

                    worksheet.Cells[2, 10].Value = "Supplier Ref No";
                    worksheet.Cells[2, 10].AutoFitColumns(8);

                    worksheet.Cells[2, 11].Value = "Cert No";
                    worksheet.Cells[2, 11].AutoFitColumns(0);

                    worksheet.Cells[2, 12].Value = "Shape";
                    worksheet.Cells[2, 12].AutoFitColumns(9);

                    worksheet.Cells[2, 13].Value = "Pointer";
                    worksheet.Cells[2, 13].AutoFitColumns(0);

                    worksheet.Cells[2, 14].Value = "Sub Pointer";
                    worksheet.Cells[2, 14].AutoFitColumns(9);

                    worksheet.Cells[2, 15].Value = "Color";
                    worksheet.Cells[2, 15].AutoFitColumns(6);

                    worksheet.Cells[2, 16].Value = "Clarity";
                    worksheet.Cells[2, 16].AutoFitColumns(8);

                    worksheet.Cells[2, 17].Value = "Cts";
                    worksheet.Cells[2, 17].AutoFitColumns(10);

                    worksheet.Cells[2, 18].Value = "Rap Rate($)";
                    worksheet.Cells[2, 18].AutoFitColumns(0);

                    worksheet.Cells[2, 19].Value = "Rap Amount($)";
                    worksheet.Cells[2, 19].AutoFitColumns(0);

                    worksheet.Cells[2, 20].Value = "Supplier Base Offer(%)";
                    worksheet.Cells[2, 20].AutoFitColumns(0);

                    worksheet.Cells[2, 21].Value = "Supplier Base Offer Value($)";
                    worksheet.Cells[2, 21].AutoFitColumns(0);

                    worksheet.Cells[2, 22].Value = "Supplier Final Disc(%)";
                    worksheet.Cells[2, 22].AutoFitColumns(0);

                    worksheet.Cells[2, 23].Value = "Supplier Final Value($)";
                    worksheet.Cells[2, 23].AutoFitColumns(0);

                    worksheet.Cells[2, 24].Value = "Supplier Final Disc. With Max Slab(%)";
                    worksheet.Cells[2, 24].AutoFitColumns(9);

                    worksheet.Cells[2, 25].Value = "Supplier Final Value With Max Slab($)";
                    worksheet.Cells[2, 25].AutoFitColumns(10.5);

                    worksheet.Cells[2, 26].Value = "Bid Disc(%)";
                    worksheet.Cells[2, 26].AutoFitColumns(0);

                    worksheet.Cells[2, 27].Value = "Bid Amt";
                    worksheet.Cells[2, 27].AutoFitColumns(0);

                    worksheet.Cells[2, 28].Value = "Bid/Ct";
                    worksheet.Cells[2, 28].AutoFitColumns(0);

                    worksheet.Cells[2, 29].Value = "Avg. Stock Disc(%)";
                    worksheet.Cells[2, 29].AutoFitColumns(5.3);

                    worksheet.Cells[2, 30].Value = "Avg. Stock Pcs";
                    worksheet.Cells[2, 30].AutoFitColumns(5.3);

                    worksheet.Cells[2, 31].Value = "Avg. Pur. Disc(%)";
                    worksheet.Cells[2, 31].AutoFitColumns(5.3);

                    worksheet.Cells[2, 32].Value = "Avg. Pur. Pcs";
                    worksheet.Cells[2, 32].AutoFitColumns(5.3);

                    worksheet.Cells[2, 33].Value = "Avg. Sales Disc(%)";
                    worksheet.Cells[2, 33].AutoFitColumns(5.3);

                    worksheet.Cells[2, 34].Value = "Sales Pcs";
                    worksheet.Cells[2, 34].AutoFitColumns(5.3);

                    worksheet.Cells[2, 35].Value = "KTS Grade";
                    worksheet.Cells[2, 35].AutoFitColumns(3.6);

                    worksheet.Cells[2, 36].Value = "Comm. Grade";
                    worksheet.Cells[2, 36].AutoFitColumns(3.6);
                    ...
                    for (i = inStartIndex; i < inEndCounter; i++)
                    {
                        ...
                        if (!string.IsNullOrEmpty(DNA_URL))
                        {
                            worksheet.Cells[inwrkrow, 1].Formula = "=HYPERLINK(\"" + DNA_URL + "\",\" DNA \")";
                        ...
                        worksheet.Cells[inwrkrow, 4].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Lab"]);
                        string URL = "";
                        string Certificate_URL = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Certificate_URL"]);
                        ...
                        if (URL != "")
                        {
                            worksheet.Cells[inwrkrow, 4].Formula = "=HYPERLINK(\"" + Convert.ToString(URL) + "\",\" " + Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Lab"]) + " \")";
                            worksheet.Cells[inwrkrow, 4].Style.Font.UnderLine = true;
                            worksheet.Cells[inwrkrow, 4].Style.Font.Color.SetColor(Color.Blue);
                        }

                        worksheet.Cells[inwrkrow, 5].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["SupplierName"]);

                        worksheet.Cells[inwrkrow, 6].Value = ((dtDiamonds.Rows[i - inStartIndex]["Rank"] != null) ?
                                      (dtDiamonds.Rows[i - inStartIndex]["Rank"].GetType().Name != "DBNull" ?
                                      Convert.ToInt32(dtDiamonds.Rows[i - inStartIndex]["Rank"]) : ((Int32?)null)) : null);

                        worksheet.Cells[inwrkrow, 6].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        worksheet.Cells[inwrkrow, 6].Style.Fill.BackgroundColor.SetColor(AM);


                        worksheet.Cells[inwrkrow, 7].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["SupplierShortName"]);

                        worksheet.Cells[inwrkrow, 8].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Buyer_Name"]);
                        worksheet.Cells[inwrkrow, 8].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        worksheet.Cells[inwrkrow, 8].Style.Fill.BackgroundColor.SetColor(H);

                        worksheet.Cells[inwrkrow, 9].Value = "";
                        worksheet.Cells[inwrkrow, 9].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        worksheet.Cells[inwrkrow, 9].Style.Fill.BackgroundColor.SetColor(I);

                        string Supplier_Stone_Id = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Supplier_Stone_Id"]);
                        success1 = Int64.TryParse(Supplier_Stone_Id, out number_1);
                        if (success1)
                        {
                            worksheet.Cells[inwrkrow, 10].Value = Convert.ToInt64(dtDiamonds.Rows[i - inStartIndex]["Supplier_Stone_Id"]);
                        }
                        else
                        {
                            worksheet.Cells[inwrkrow, 10].Value = Supplier_Stone_Id;
                        }
                        ...
                        if (success1)
                        {
                            worksheet.Cells[inwrkrow, 11].Value = Convert.ToInt64(dtDiamonds.Rows[i - inStartIndex]["Certificate_No"]);
                        }
                        else
                        {
                            worksheet.Cells[inwrkrow, 11].Value = Certificate_No;
                        }
                        ...
                        worksheet.Cells[inwrkrow, 14].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Sub_Pointer"]);
                        ...
                        worksheet.Cells[inwrkrow, 18].Value = ((dtDiamonds.Rows[i - inStartIndex]["Rap_Rate"] != null) ?
                                     (dtDiamonds.Rows[i - inStartIndex]["Rap_Rate"].GetType().Name != "DBNull" ?
                                     Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Rap_Rate"]) : ((Double?)null)) : null);
                        ...
                        worksheet.Cells[inwrkrow, 20].Value = ((dtDiamonds.Rows[i - inStartIndex]["Disc"] != null) ?
                                     (dtDiamonds.Rows[i - inStartIndex]["Disc"].GetType().Name != "DBNull" ?
                                     Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Disc"]) : ((Double?)null)) : null);
                        ...
                        worksheet.Cells[inwrkrow, 20].Style.Fill.BackgroundColor.SetColor(T_U);

                        worksheet.Cells[inwrkrow, 21].Value = ((dtDiamonds.Rows[i - inStartIndex]["Value"] != null) ?
                                    (dtDiamonds.Rows[i - inStartIndex]["Value"].GetType().Name != "DBNull" ?
                                    Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Value"]) : ((Double?)null)) : null);
                        worksheet.Cells[inwrkrow, 21].Style.Numberformat.Format = "#,##0.00";
                        worksheet.Cells[inwrkrow, 21].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        worksheet.Cells[inwrkrow, 21].Style.Fill.BackgroundColor.SetColor(T_U);

                        worksheet.Cells[inwrkrow, 22].Value = ((dtDiamonds.Rows[i - inStartIndex]["SUPPLIER_COST_DISC"] != null) ?
                                     (dtDiamonds.Rows[i - inStartIndex]["SUPPLIER_COST_DISC"].GetType().Name != "DBNull" ?
                                     Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["SUPPLIER_COST_DISC"]) : ((Double?)null)) : null);
                        ...
                        worksheet.Cells[inwrkrow, 22].Style.Fill.BackgroundColor.SetColor(V_W);

                        worksheet.Cells[inwrkrow, 23].Value = ((dtDiamonds.Rows[i - inStartIndex]["SUPPLIER_COST_VALUE"] != null) ?
                                     (dtDiamonds.Rows[i - inStartIndex]["SUPPLIER_COST_VALUE"].GetType().Name != "DBNull" ?
                                     Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["SUPPLIER_COST_VALUE"]) : ((Double?)null)) : null);
                        ...
                        worksheet.Cells[inwrkrow, 23].Style.Fill.BackgroundColor.SetColor(V_W);

                        worksheet.Cells[inwrkrow, 24].Value = ((dtDiamonds.Rows[i - inStartIndex]["MAX_DISC"] != null) ?
                                     (dtDiamonds.Rows[i - inStartIndex]["MAX_DISC"].GetType().Name != "DBNull" ?
                                     Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["MAX_DISC"]) : ((Double?)null)) : null);
                        ...
                        worksheet.Cells[inwrkrow, 24].Style.Fill.BackgroundColor.SetColor(X_Y);

                        worksheet.Cells[inwrkrow, 25].Value = ((dtDiamonds.Rows[i - inStartIndex]["MAX_VALUE"] != null) ?
                                     (dtDiamonds.Rows[i - inStartIndex]["MAX_VALUE"].GetType().Name != "DBNull" ?
                                     Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["MAX_VALUE"]) : ((Double?)null)) : null);
                        ...
                        worksheet.Cells[inwrkrow, 25].Style.Fill.BackgroundColor.SetColor(X_Y);

                        worksheet.Cells[inwrkrow, 26].Value = ((dtDiamonds.Rows[i - inStartIndex]["Bid_Disc"] != null) ?
                                      (dtDiamonds.Rows[i - inStartIndex]["Bid_Disc"].GetType().Name != "DBNull" ?
                                      Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Bid_Disc"]) : ((Double?)null)) : null);
                        ...
                        worksheet.Cells[inwrkrow, 26].Style.Fill.BackgroundColor.SetColor(Z_AA_AB);

                        worksheet.Cells[inwrkrow, 27].Value = ((dtDiamonds.Rows[i - inStartIndex]["Bid_Amt"] != null) ?
                                     (dtDiamonds.Rows[i - inStartIndex]["Bid_Amt"].GetType().Name != "DBNull" ?
                                     Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Bid_Amt"]) : ((Double?)null)) : null);
                        ...
                        worksheet.Cells[inwrkrow, 27].Style.Fill.BackgroundColor.SetColor(Z_AA_AB);

                        worksheet.Cells[inwrkrow, 28].Value = ((dtDiamonds.Rows[i - inStartIndex]["Bid_Ct"] != null) ?
                                     (dtDiamonds.Rows[i - inStartIndex]["Bid_Ct"].GetType().Name != "DBNull" ?
                                     Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Bid_Ct"]) : ((Double?)null)) : null);
                        ...
                        worksheet.Cells[inwrkrow, 28].Style.Fill.BackgroundColor.SetColor(Z_AA_AB);

                        worksheet.Cells[inwrkrow, 29].Value = ((dtDiamonds.Rows[i - inStartIndex]["Avg_Stock_Disc"] != null) ?
                                      (dtDiamonds.Rows[i - inStartIndex]["Avg_Stock_Disc"].GetType().Name != "DBNull" ?
                                      Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Avg_Stock_Disc"]) : ((Double?)null)) : null);
                        ...
                        worksheet.Cells[inwrkrow, 29].Style.Fill.BackgroundColor.SetColor(AE_AF);

                        worksheet.Cells[inwrkrow, 30].Value = ((dtDiamonds.Rows[i - inStartIndex]["Avg_Stock_Pcs"] != null) ?
                                     (dtDiamonds.Rows[i - inStartIndex]["Avg_Stock_Pcs"].GetType().Name != "DBNull" ?
                                     Convert.ToInt64(dtDiamonds.Rows[i - inStartIndex]["Avg_Stock_Pcs"]) : ((Int64?)null)) : null);
                        worksheet.Cells[inwrkrow, 30].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        worksheet.Cells[inwrkrow, 30].Style.Fill.BackgroundColor.SetColor(AE_AF);

                        worksheet.Cells[inwrkrow, 31].Value = ((dtDiamonds.Rows[i - inStartIndex]["Avg_Pur_Disc"] != null) ?
                                      (dtDiamonds.Rows[i - inStartIndex]["Avg_Pur_Disc"].GetType().Name != "DBNull" ?
                                      Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Avg_Pur_Disc"]) : ((Double?)null)) : null);
                        worksheet.Cells[inwrkrow, 31].Style.Numberformat.Format = "#,##0.00";
                        worksheet.Cells[inwrkrow, 31].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        worksheet.Cells[inwrkrow, 31].Style.Fill.BackgroundColor.SetColor(AG_AH);

                        worksheet.Cells[inwrkrow, 32].Value = ((dtDiamonds.Rows[i - inStartIndex]["Avg_Pur_Pcs"] != null) ?
                                      (dtDiamonds.Rows[i - inStartIndex]["Avg_Pur_Pcs"].GetType().Name != "DBNull" ?
                                      Convert.ToInt64(dtDiamonds.Rows[i - inStartIndex]["Avg_Pur_Pcs"]) : ((Int64?)null)) : null);
                        worksheet.Cells[inwrkrow, 32].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        worksheet.Cells[inwrkrow, 32].Style.Fill.BackgroundColor.SetColor(AG_AH);

                        worksheet.Cells[inwrkrow, 33].Value = ((dtDiamonds.Rows[i - inStartIndex]["Avg_Sales_Disc"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Avg_Sales_Disc"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Avg_Sales_Disc"]) : ((Double?)null)) : null);
                        ...
                        worksheet.Cells[inwrkrow, 33].Style.Fill.BackgroundColor.SetColor(AI_AJ);

                        worksheet.Cells[inwrkrow, 34].Value = ((dtDiamonds.Rows[i - inStartIndex]["Sales_Pcs"] != null) ?
                                     (dtDiamonds.Rows[i - inStartIndex]["Sales_Pcs"].GetType().Name != "DBNull" ?
                                     Convert.ToInt64(dtDiamonds.Rows[i - inStartIndex]["Sales_Pcs"]) : ((Int64?)null)) : null);
                        worksheet.Cells[inwrkrow, 34].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        worksheet.Cells[inwrkrow, 34].Style.Fill.BackgroundColor.SetColor(AI_AJ);
                        ...
                        worksheet.Cells[inwrkrow, 36].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Comm_Grade"]);
                        worksheet.Cells[inwrkrow, 36].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        worksheet.Cells[inwrkrow, 36].Style.Fill.BackgroundColor.SetColor(AL);

                        worksheet.Cells[inwrkrow, 37].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Zone"]);
                    ...
                    worksheet.Cells[inStartIndex, 1, inEndCounter, 69].Style.Font.Size = 9;
                    ...
                    worksheet.Cells[1, 10].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[1, 10].Style.Numberformat.Format = "#,##";

                    ExcelStyle cellStyleHeader_Total = worksheet.Cells[1, 10].Style;
                    cellStyleHeader_Total.Border.Left.Style = cellStyleHeader_Total.Border.Right.Style
                            = cellStyleHeader_Total.Border.Top.Style = cellStyleHeader_Total.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Cts"
                    worksheet.Cells[1, 17].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(17) + "" + inStartIndex + ":" + GetExcelColumnLetter(17) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[1, 17].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[1, 17].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[1, 17].Style.Numberformat.Format = "#,##0.00";

                    ExcelStyle cellStyleHeader_Totalcarat = worksheet.Cells[1, 17].Style;
                    cellStyleHeader_Totalcarat.Border.Left.Style = cellStyleHeader_Totalcarat.Border.Right.Style
                            = cellStyleHeader_Totalcarat.Border.Top.Style = cellStyleHeader_Totalcarat.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Rap Amount($)"
                    worksheet.Cells[1, 19].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(19) + "" + inStartIndex + ":" + GetExcelColumnLetter(19) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[1, 19].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[1, 19].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[1, 19].Style.Numberformat.Format = "#,##0";

                    ExcelStyle cellStyleHeader_RapAmt = worksheet.Cells[1, 19].Style;
                    cellStyleHeader_RapAmt.Border.Left.Style = cellStyleHeader_RapAmt.Border.Right.Style
                            = cellStyleHeader_RapAmt.Border.Top.Style = cellStyleHeader_RapAmt.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Supplier Base Offer(%)"
                    int Rap_Amount = 19, Supplier_Base_Offer_Value_Doller = 21;
                    if (Rap_Amount != 0 && Supplier_Base_Offer_Value_Doller != 0)
                    {
                        worksheet.Cells[1, 20].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(Supplier_Base_Offer_Value_Doller) + "" + inStartIndex + ":" + GetExcelColumnLetter(Supplier_Base_Offer_Value_Doller) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")))*(-100),2))";
                        worksheet.Cells[1, 20].Style.Numberformat.Format = "#,##0.00";

                        ExcelStyle cellStyleHeader_TotalDis = worksheet.Cells[1, 20].Style;
                        cellStyleHeader_TotalDis.Border.Left.Style = cellStyleHeader_TotalDis.Border.Right.Style
                                = cellStyleHeader_TotalDis.Border.Top.Style = cellStyleHeader_TotalDis.Border.Bottom.Style
                                = ExcelBorderStyle.Medium;
                    }

                    //  "Supplier Base Offer Value($)"
                    worksheet.Cells[1, 21].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(21) + "" + inStartIndex + ":" + GetExcelColumnLetter(21) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[1, 21].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[1, 21].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[1, 21].Style.Numberformat.Format = "#,##0";

                    ExcelStyle cellStyleHeader_TotalAmt = worksheet.Cells[1, 21].Style;
                    cellStyleHeader_TotalAmt.Border.Left.Style = cellStyleHeader_TotalAmt.Border.Right.Style
                            = cellStyleHeader_TotalAmt.Border.Top.Style = cellStyleHeader_TotalAmt.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Supplier Final Disc(%)"
                    int Supplier_Final_Value_Doller = 23;
                    if (Rap_Amount != 0 && Supplier_Final_Value_Doller != 0)
                    {
                        worksheet.Cells[1, 22].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ": " + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(Supplier_Final_Value_Doller) + "" + inStartIndex + ":" + GetExcelColumnLetter(Supplier_Final_Value_Doller) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")))*(-100),2))";
                        worksheet.Cells[1, 22].Style.Numberformat.Format = "#,##0.00";

                        ExcelStyle cellStyleHeader_TotalDis_1 = worksheet.Cells[1, 22].Style;
                        cellStyleHeader_TotalDis_1.Border.Left.Style = cellStyleHeader_TotalDis_1.Border.Right.Style
                                = cellStyleHeader_TotalDis_1.Border.Top.Style = cellStyleHeader_TotalDis_1.Border.Bottom.Style
                                = ExcelBorderStyle.Medium;
                    }
                    ...
                    worksheet.Cells[1, 23].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(23) + "" + inStartIndex + ":" + GetExcelColumnLetter(23) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[1, 23].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[1, 23].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[1, 23].Style.Numberformat.Format = "#,##0";

                    ExcelStyle cellStyleHeader_TotalAmt_1 = worksheet.Cells[1, 23].Style;
                    cellStyleHeader_TotalAmt_1.Border.Left.Style = cellStyleHeader_TotalAmt_1.Border.Right.Style
                            = cellStyleHeader_TotalAmt_1.Border.Top.Style = cellStyleHeader_TotalAmt_1.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Supplier Final Disc. With Max Slab(%)"
                    int Supplier_Final_Value_With_Max_Slab_Doller = 25;
                    if (Rap_Amount != 0 && Supplier_Final_Value_With_Max_Slab_Doller != 0)
                    {
                        worksheet.Cells[1, 24].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(Supplier_Final_Value_With_Max_Slab_Doller) + "" + inStartIndex + ":" + GetExcelColumnLetter(Supplier_Final_Value_With_Max_Slab_Doller) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")))*(-100),2))";
                        worksheet.Cells[1, 24].Style.Numberformat.Format = "#,##0.00";

                        ExcelStyle cellStyleHeader_TotalDis_2 = worksheet.Cells[1, 24].Style;
                        cellStyleHeader_TotalDis_2.Border.Left.Style = cellStyleHeader_TotalDis_2.Border.Right.Style
                                = cellStyleHeader_TotalDis_2.Border.Top.Style = cellStyleHeader_TotalDis_2.Border.Bottom.Style
                                = ExcelBorderStyle.Medium;
                    }

                    //  "Supplier Final Value With Max Slab($)"
                    worksheet.Cells[1, 25].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(25) + "" + inStartIndex + ":" + GetExcelColumnLetter(25) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[1, 25].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[1, 25].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[1, 25].Style.Numberformat.Format = "#,##0";

                    ExcelStyle cellStyleHeader_TotalAmt_2 = worksheet.Cells[1, 25].Style;
                    cellStyleHeader_TotalAmt_2.Border.Left.Style = cellStyleHeader_TotalAmt_2.Border.Right.Style
                            = cellStyleHeader_TotalAmt_2.Border.Top.Style = cellStyleHeader_TotalAmt_2.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
                    ...
                    if (Rap_Amount != 0 && Bid_Amt != 0)
                    {
                        worksheet.Cells[1, 26].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(Bid_Amt) + "" + inStartIndex + ":" + GetExcelColumnLetter(Bid_Amt) + "" + (inwrkrow - 1) + ")=0,0, IF(SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(Bid_Amt) + "" + inStartIndex + ":" + GetExcelColumnLetter(Bid_Amt) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")))*(-100),2)))";
                        worksheet.Cells[1, 26].Style.Numberformat.Format = "#,##0.00";

                        ExcelStyle cellStyleHeader_TotalDis = worksheet.Cells[1, 26].Style;
                        cellStyleHeader_TotalDis.Border.Left.Style = cellStyleHeader_TotalDis.Border.Right.Style
                                = cellStyleHeader_TotalDis.Border.Top.Style = cellStyleHeader_TotalDis.Border.Bottom.Style
                                = ExcelBorderStyle.Medium;
                    }
                    ...
                    //  "Bid Amt"
                    worksheet.Cells[1, 27].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(27) + "" + inStartIndex + ":" + GetExcelColumnLetter(27) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[1, 27].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[1, 27].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[1, 27].Style.Numberformat.Format = "#,##0";

                    ExcelStyle cellStyleHeader_TotalAmt_3 = worksheet.Cells[1, 27].Style;
                    cellStyleHeader_TotalAmt_3.Border.Left.Style = cellStyleHeader_TotalAmt_3.Border.Right.Style
                            = cellStyleHeader_TotalAmt_3.Border.Top.Style = cellStyleHeader_TotalAmt_3.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
                    ...
                    if (Cts != 0 && Bid_Amt != 0)
                    {
                        worksheet.Cells[1, 28].Formula = "=+SUBTOTAL(109," + GetExcelColumnLetter(Bid_Amt) + "" + inStartIndex + ":" + GetExcelColumnLetter(Bid_Amt) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(Cts) + "" + inStartIndex + ":" + GetExcelColumnLetter(Cts) + "" + (inwrkrow - 1) + ")";
                        worksheet.Cells[1, 28].Style.Numberformat.Format = "#,##0.00";

                        ExcelStyle cellStyleHeader_TotalDis = worksheet.Cells[1, 28].Style;
                        cellStyleHeader_TotalDis.Border.Left.Style = cellStyleHeader_TotalDis.Border.Right.Style
                                = cellStyleHeader_TotalDis.Border.Top.Style = cellStyleHeader_TotalDis.Border.Bottom.Style
                                = ExcelBorderStyle.Medium;
                    }
        ...
        public static void Buyer_Excel(DataTable dtDiamonds, DataTable Col_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage p = new ExcelPackage())
                {
                    ...
                    #region Header Name Declaration & AutoFit Format
                    ...
                    worksheet.Cells[inStartIndex, 17, (inwrkrow - 1), 29].Style.Numberformat.Format = "#,##0.00";
                    worksheet.Cells[inStartIndex, 31, (inwrkrow - 1), 31].Style.Numberformat.Format = "#,##0.00";
                    worksheet.Cells[inStartIndex, 33, (inwrkrow - 1), 33].Style.Numberformat.Format = "#,##0.00";
        ...
        public static void Supplier_Excel_Old(DataTable dtDiamonds, DataTable Col_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage p = new ExcelPackage())
        ...
        public static void Supplier_Excel(DataTable dtDiamonds, DataTable Col_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage p = new ExcelPackage())
                {
                    ...
                    worksheet.Cells[2, 1].Value = "Ref No";
                    worksheet.Cells[2, 1].AutoFitColumns(12);

                    worksheet.Cells[2, 2].Value = "Lab";
                    worksheet.Cells[2, 2].AutoFitColumns(8);

                    worksheet.Cells[2, 3].Value = "Image";
                    worksheet.Cells[2, 3].AutoFitColumns(7);

                    worksheet.Cells[2, 4].Value = "Video";
                    worksheet.Cells[2, 4].AutoFitColumns(7);

                    worksheet.Cells[2, 5].Value = "Supplier Ref No";
                    worksheet.Cells[2, 5].AutoFitColumns(15);

                    worksheet.Cells[2, 6].Value = "Cert No";
                    worksheet.Cells[2, 6].AutoFitColumns(12);

                    worksheet.Cells[2, 7].Value = "Supplier Name";
                    worksheet.Cells[2, 7].AutoFitColumns(12);

                    worksheet.Cells[2, 8].Value = "Shape";
                    worksheet.Cells[2, 8].AutoFitColumns(10);

                    worksheet.Cells[2, 9].Value = "Pointer";
                    worksheet.Cells[2, 9].AutoFitColumns(9);

                    worksheet.Cells[2, 10].Value = "BGM";
                    worksheet.Cells[2, 10].AutoFitColumns(9);

                    worksheet.Cells[2, 11].Value = "Color";
                    worksheet.Cells[2, 11].AutoFitColumns(8);

                    worksheet.Cells[2, 12].Value = "Clarity";
                    worksheet.Cells[2, 12].AutoFitColumns(8);

                    worksheet.Cells[2, 13].Value = "Cts";
                    worksheet.Cells[2, 13].AutoFitColumns(8);

                    worksheet.Cells[2, 14].Value = "Rap Rate($)";
                    worksheet.Cells[2, 14].AutoFitColumns(11);

                    worksheet.Cells[2, 15].Value = "Rap Amount($)";
                    worksheet.Cells[2, 15].AutoFitColumns(11);

                    worksheet.Cells[2, 16].Value = "Supplier Cost Disc(%)";
                    worksheet.Cells[2, 16].AutoFitColumns(11.5);

                    worksheet.Cells[2, 17].Value = "Supplier Cost Value($)";
                    worksheet.Cells[2, 17].AutoFitColumns(11.5);

                    worksheet.Cells[2, 18].Value = "Final Disc(%)";
                    worksheet.Cells[2, 18].AutoFitColumns(10.5);

                    worksheet.Cells[2, 19].Value = "Final Amt US($)";
                    worksheet.Cells[2, 19].AutoFitColumns(11.5);

                    worksheet.Cells[2, 20].Value = "Supplier Base Offer(%)";
                    worksheet.Cells[2, 20].AutoFitColumns(11.5);

                    worksheet.Cells[2, 21].Value = "Supplier Base Offer Value($)";
                    worksheet.Cells[2, 21].AutoFitColumns(11.5);

                    worksheet.Cells[2, 22].Value = "Cut";
                    worksheet.Cells[2, 22].AutoFitColumns(8);

                    worksheet.Cells[2, 23].Value = "Polish";
                    worksheet.Cells[2, 23].AutoFitColumns(8);

                    worksheet.Cells[2, 24].Value = "Symm";
                    worksheet.Cells[2, 24].AutoFitColumns(8);

                    worksheet.Cells[2, 25].Value = "Fls";
                    worksheet.Cells[2, 25].AutoFitColumns(8);

                    worksheet.Cells[2, 26].Value = "Length";
                    worksheet.Cells[2, 26].AutoFitColumns(8);

                    worksheet.Cells[2, 27].Value = "Width";
                    worksheet.Cells[2, 27].AutoFitColumns(8);

                    worksheet.Cells[2, 28].Value = "Depth";
                    worksheet.Cells[2, 28].AutoFitColumns(8);

                    worksheet.Cells[2, 29].Value = "Depth(%)";
                    worksheet.Cells[2, 29].AutoFitColumns(8);

                    worksheet.Cells[2, 30].Value = "Table(%)";
                    worksheet.Cells[2, 30].AutoFitColumns(8);

                    worksheet.Cells[2, 31].Value = "Key To Symbol";
                    worksheet.Cells[2, 31].AutoFitColumns(25);

                    worksheet.Cells[2, 32].Value = "Comment";
                    worksheet.Cells[2, 32].AutoFitColumns(25);

                    worksheet.Cells[2, 33].Value = "Girdle(%)";
                    worksheet.Cells[2, 33].AutoFitColumns(8);

                    worksheet.Cells[2, 34].Value = "Crown Angle";
                    worksheet.Cells[2, 34].AutoFitColumns(8);

                    worksheet.Cells[2, 35].Value = "Crown Height";
                    worksheet.Cells[2, 35].AutoFitColumns(8);

                    worksheet.Cells[2, 36].Value = "Pavilion Angle";
                    worksheet.Cells[2, 36].AutoFitColumns(8);

                    worksheet.Cells[2, 37].Value = "Pavilion Height";
                    worksheet.Cells[2, 37].AutoFitColumns(8);

                    worksheet.Cells[2, 38].Value = "Table Black";
                    worksheet.Cells[2, 38].AutoFitColumns(8);

                    worksheet.Cells[2, 39].Value = "Crown Black";
                    worksheet.Cells[2, 39].AutoFitColumns(8);

                    worksheet.Cells[2, 40].Value = "Table White";
                    worksheet.Cells[2, 40].AutoFitColumns(8);

                    worksheet.Cells[2, 41].Value = "Crown White";
                    worksheet.Cells[2, 41].AutoFitColumns(8);

                    worksheet.Cells[2, 42].Value = "Culet";
                    worksheet.Cells[2, 42].AutoFitColumns(8);

                    worksheet.Cells[2, 43].Value = "Table Open";
                    worksheet.Cells[2, 43].AutoFitColumns(8);

                    worksheet.Cells[2, 44].Value = "Crown Open";
                    worksheet.Cells[2, 44].AutoFitColumns(8);

                    worksheet.Cells[2, 45].Value = "Pav Open";
                    worksheet.Cells[2, 45].AutoFitColumns(8);

                    worksheet.Cells[2, 46].Value = "Girdle Open";
                    worksheet.Cells[2, 46].AutoFitColumns(8);


                    worksheet.Cells[1, 1].Value = "Total";
                    worksheet.Cells[1, 1, 1, 46].Style.Font.Bold = true;
                    worksheet.Cells[1, 1, 1, 46].Style.Font.Size = 11;
                    worksheet.Cells[1, 1, 1, 46].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    worksheet.Cells[1, 1, 1, 46].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                    worksheet.Cells[1, 1, 1, 46].Style.Font.Size = 11;

                    worksheet.Cells[2, 1, 2, 46].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    worksheet.Cells[2, 1, 2, 46].Style.VerticalAlignment = ExcelVerticalAlignment.Top;
                    worksheet.Cells[2, 1, 2, 46].Style.Font.Size = 10;
                    worksheet.Cells[2, 1, 2, 46].Style.Font.Bold = true;

                    worksheet.Cells[2, 1, 2, 46].AutoFilter = true;

                    var cellBackgroundColor1 = worksheet.Cells[2, 1, 2, 46].Style.Fill;
                    cellBackgroundColor1.PatternType = ExcelFillStyle.Solid;
                    Color colFromHex = System.Drawing.ColorTranslator.FromHtml("#d3d3d3");
                    cellBackgroundColor1.BackgroundColor.SetColor(colFromHex);

                    ExcelStyle cellStyleHeader1 = worksheet.Cells[2, 1, 2, 46].Style;
                    cellStyleHeader1.Border.Left.Style = cellStyleHeader1.Border.Right.Style
                            = cellStyleHeader1.Border.Top.Style = cellStyleHeader1.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
                    ...
                    for (i = inStartIndex; i < inEndCounter; i++)
                    {
                        ...
                        if (success1)
                        {
                            worksheet.Cells[inwrkrow, 5].Value = Convert.ToInt64(dtDiamonds.Rows[i - inStartIndex]["Supplier_Stone_Id"]);
                        }
                        else
                        {
                            worksheet.Cells[inwrkrow, 5].Value = Supplier_Stone_Id;
                        }
                        ...
                        if (success1)
                        {
                            worksheet.Cells[inwrkrow, 6].Value = Convert.ToInt64(dtDiamonds.Rows[i - inStartIndex]["Certificate_No"]);
                        }
                        else
                        {
                            worksheet.Cells[inwrkrow, 6].Value = Certificate_No;
                        }
                        ...
                        worksheet.Cells[inwrkrow, 16].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(15) + "" + inwrkrow + ":" + GetExcelColumnLetter(15) + "" + inwrkrow + ")=0,0,ROUND((1-(" + GetExcelColumnLetter(17) + "" + inwrkrow + "/" + GetExcelColumnLetter(15) + "" + inwrkrow + "))*(-100),2))";
                        ...
                        //worksheet.Cells[inwrkrow, 16].Style.Fill.BackgroundColor.SetColor(cellBg1);
                        ...
                        //worksheet.Cells[inwrkrow, 17].Style.Fill.BackgroundColor.SetColor(cellBg1);

                        //worksheet.Cells[inwrkrow, 18].Value = ((dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_DISC"] != null) ?
                        //            (dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_DISC"].GetType().Name != "DBNull" ?
                        //            Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_DISC"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 18].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(15) + "" + inwrkrow + ":" + GetExcelColumnLetter(15) + "" + inwrkrow + ")=0,0,ROUND((1-(" + GetExcelColumnLetter(19) + "" + inwrkrow + "/" + GetExcelColumnLetter(15) + "" + inwrkrow + "))*(-100),2))";
                        worksheet.Cells[inwrkrow, 18].Style.Numberformat.Format = "#,##0.00";

                        //worksheet.Cells[inwrkrow, 18].Style.Numberformat.Format = "#,##0.00";
                        //worksheet.Cells[inwrkrow, 18].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        //worksheet.Cells[inwrkrow, 18].Style.Fill.BackgroundColor.SetColor(cellBg);
                        ...
                        //worksheet.Cells[inwrkrow, 19].Style.Fill.BackgroundColor.SetColor(cellBg);

                        //worksheet.Cells[inwrkrow, 20].Value = ((dtDiamonds.Rows[i - inStartIndex]["Disc"] != null) ?
                        //           (dtDiamonds.Rows[i - inStartIndex]["Disc"].GetType().Name != "DBNull" ?
                        //           Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Disc"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 20].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(15) + "" + inwrkrow + ":" + GetExcelColumnLetter(15) + "" + inwrkrow + ")=0,0,ROUND((1-(" + GetExcelColumnLetter(21) + "" + inwrkrow + "/" + GetExcelColumnLetter(15) + "" + inwrkrow + "))*(-100),2))";
                        worksheet.Cells[inwrkrow, 20].Style.Numberformat.Format = "#,##0.00";
                        ...
                        worksheet.Cells[inwrkrow, 22].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Cut"]);
                        if (Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Cut"]).ToUpper() == "3EX")
                        {
                        ...
                        worksheet.Cells[inwrkrow, 30].Value = ((dtDiamonds.Rows[i - inStartIndex]["Table_Per"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Table_Per"].GetType().Name != "DBNull" ?
                                       Convert.ToInt32(dtDiamonds.Rows[i - inStartIndex]["Table_Per"]) : ((Int32?)null)) : null);
                        //worksheet.Cells[inwrkrow, 30].Style.Numberformat.Format = "0";

                        worksheet.Cells[inwrkrow, 31].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Key_To_Symboll"]);
                    ...
                    worksheet.Cells[inStartIndex, 30, (inwrkrow - 1), 30].Style.Numberformat.Format = "0";
                    ...
                    ExcelStyle cellStyleHeader_Total = worksheet.Cells[1, 8].Style;
                    cellStyleHeader_Total.Border.Left.Style = cellStyleHeader_Total.Border.Right.Style
                            = cellStyleHeader_Total.Border.Top.Style = cellStyleHeader_Total.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Cts"
                    worksheet.Cells[1, 13].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(13) + "" + inStartIndex + ":" + GetExcelColumnLetter(13) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[1, 13].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[1, 13].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[1, 13].Style.Numberformat.Format = "#,##0.00";
                    ExcelStyle cellStyleHeader_Totalcarat = worksheet.Cells[1, 13].Style;
                    cellStyleHeader_Totalcarat.Border.Left.Style = cellStyleHeader_Totalcarat.Border.Right.Style
                            = cellStyleHeader_Totalcarat.Border.Top.Style = cellStyleHeader_Totalcarat.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Rap Amount($)"
                    worksheet.Cells[1, 15].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(15) + "" + inStartIndex + ":" + GetExcelColumnLetter(15) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[1, 15].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[1, 15].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[1, 15].Style.Numberformat.Format = "#,##0";
                    ExcelStyle cellStyleHeader_RapAmt = worksheet.Cells[1, 15].Style;
                    cellStyleHeader_RapAmt.Border.Left.Style = cellStyleHeader_RapAmt.Border.Right.Style
                            = cellStyleHeader_RapAmt.Border.Top.Style = cellStyleHeader_RapAmt.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Supplier Cost Disc(%)"
                    int Rap_Amount = 15, Supplier_Cost_Value_Doller = 17;
                    if (Rap_Amount != 0 && Supplier_Cost_Value_Doller != 0)
                    {
                        worksheet.Cells[1, 16].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(Supplier_Cost_Value_Doller) + "" + inStartIndex + ":" + GetExcelColumnLetter(Supplier_Cost_Value_Doller) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")))*(-100),2))";
                        worksheet.Cells[1, 16].Style.Numberformat.Format = "#,##0.00";

                        ExcelStyle cellStyleHeader_TotalDis = worksheet.Cells[1, 16].Style;
                        cellStyleHeader_TotalDis.Border.Left.Style = cellStyleHeader_TotalDis.Border.Right.Style
                                = cellStyleHeader_TotalDis.Border.Top.Style = cellStyleHeader_TotalDis.Border.Bottom.Style
                                = ExcelBorderStyle.Medium;
                    }
                    ...
                    ExcelStyle cellStyleHeader_TotalAmt = worksheet.Cells[1, 17].Style;
                    cellStyleHeader_TotalAmt.Border.Left.Style = cellStyleHeader_TotalAmt.Border.Right.Style
                            = cellStyleHeader_TotalAmt.Border.Top.Style = cellStyleHeader_TotalAmt.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Final Disc(%)"
                    int Sunrise_Value_US_Doller = 19;
                    if (Rap_Amount != 0 && Sunrise_Value_US_Doller != 0)
                    {
                        worksheet.Cells[1, 18].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ": " + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(Sunrise_Value_US_Doller) + "" + inStartIndex + ":" + GetExcelColumnLetter(Sunrise_Value_US_Doller) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")))*(-100),2))";
                        worksheet.Cells[1, 18].Style.Numberformat.Format = "#,##0.00";

                        ExcelStyle cellStyleHeader_TotalDis_1 = worksheet.Cells[1, 18].Style;
                        cellStyleHeader_TotalDis_1.Border.Left.Style = cellStyleHeader_TotalDis_1.Border.Right.Style
                                = cellStyleHeader_TotalDis_1.Border.Top.Style = cellStyleHeader_TotalDis_1.Border.Bottom.Style
                                = ExcelBorderStyle.Medium;
                    }
                    ...
                    ExcelStyle cellStyleHeader_TotalAmt_1 = worksheet.Cells[1, 19].Style;
                    cellStyleHeader_TotalAmt_1.Border.Left.Style = cellStyleHeader_TotalAmt_1.Border.Right.Style
                            = cellStyleHeader_TotalAmt_1.Border.Top.Style = cellStyleHeader_TotalAmt_1.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Supplier Base Offer(%)"
                    int Supplier_Base_Offer_Value_Doller = 21;
                    if (Rap_Amount != 0 && Supplier_Base_Offer_Value_Doller != 0)
                    {
                        worksheet.Cells[1, 20].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(Supplier_Base_Offer_Value_Doller) + "" + inStartIndex + ":" + GetExcelColumnLetter(Supplier_Base_Offer_Value_Doller) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")))*(-100),2))";
                        worksheet.Cells[1, 20].Style.Numberformat.Format = "#,##0.00";

                        ExcelStyle cellStyleHeader_TotalDis_2 = worksheet.Cells[1, 20].Style;
                        cellStyleHeader_TotalDis_2.Border.Left.Style = cellStyleHeader_TotalDis_2.Border.Right.Style
                                = cellStyleHeader_TotalDis_2.Border.Top.Style = cellStyleHeader_TotalDis_2.Border.Bottom.Style
                                = ExcelBorderStyle.Medium;
                    }
                    ...
                    ExcelStyle cellStyleHeader_TotalAmt_2 = worksheet.Cells[1, 21].Style;
                    cellStyleHeader_TotalAmt_2.Border.Left.Style = cellStyleHeader_TotalAmt_2.Border.Right.Style
                            = cellStyleHeader_TotalAmt_2.Border.Top.Style = cellStyleHeader_TotalAmt_2.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
        ...
        public static void Status_Excel(DataTable dtDiamonds, DataTable Col_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage p = new ExcelPackage())
                {
                    ...
                    //p.Workbook.Properties.Author = "SUNRISE DIAMOND";
                    //p.Workbook.Properties.Title = "SUNRISE DIAMOND PVT. LTD.";
                    p.Workbook.Worksheets.Add("Status");
                    ...
                    worksheet.Cells[2, 8].AutoFitColumns(12);

                    worksheet.Cells[2, 9].Value = "Shape";
                    worksheet.Cells[2, 9].AutoFitColumns(10);

                    worksheet.Cells[2, 10].Value = "Pointer";
                    worksheet.Cells[2, 10].AutoFitColumns(9);

                    worksheet.Cells[2, 11].Value = "BGM";
                    worksheet.Cells[2, 11].AutoFitColumns(9);
                    ...
                    worksheet.Cells[2, 14].AutoFitColumns(8);

                    worksheet.Cells[2, 15].Value = "Rap Rate($)";
                    worksheet.Cells[2, 15].AutoFitColumns(11);

                    worksheet.Cells[2, 16].Value = "Rap Amount($)";
                    worksheet.Cells[2, 16].AutoFitColumns(11);

                    worksheet.Cells[2, 17].Value = "Revised Disc(%)";
                    worksheet.Cells[2, 17].AutoFitColumns(11);

                    worksheet.Cells[2, 18].Value = "Revised Amt($)";
                    worksheet.Cells[2, 18].AutoFitColumns(11);

                    worksheet.Cells[2, 19].Value = "Difference";
                    worksheet.Cells[2, 19].AutoFitColumns(11);

                    worksheet.Cells[2, 20].Value = "Supplier Cost Disc(%)";
                    worksheet.Cells[2, 20].AutoFitColumns(11.5);

                    worksheet.Cells[2, 21].Value = "Supplier Cost Value($)";
                    worksheet.Cells[2, 21].AutoFitColumns(11.5);

                    worksheet.Cells[2, 22].Value = "Final Disc(%)";
                    worksheet.Cells[2, 22].AutoFitColumns(10.5);

                    worksheet.Cells[2, 23].Value = "Final Amt US($)";
                    worksheet.Cells[2, 23].AutoFitColumns(11.5);

                    worksheet.Cells[2, 24].Value = "Supplier Base Offer(%)";
                    worksheet.Cells[2, 24].AutoFitColumns(11.5);

                    worksheet.Cells[2, 25].Value = "Supplier Base Offer Value($)";
                    worksheet.Cells[2, 25].AutoFitColumns(11.5);

                    worksheet.Cells[2, 26].Value = "Cut";
                    worksheet.Cells[2, 26].AutoFitColumns(8);

                    worksheet.Cells[2, 27].Value = "Polish";
                    worksheet.Cells[2, 27].AutoFitColumns(8);

                    worksheet.Cells[2, 28].Value = "Symm";
                    worksheet.Cells[2, 28].AutoFitColumns(8);

                    worksheet.Cells[2, 29].Value = "Fls";
                    worksheet.Cells[2, 29].AutoFitColumns(8);

                    worksheet.Cells[2, 30].Value = "Length";
                    worksheet.Cells[2, 30].AutoFitColumns(8);

                    worksheet.Cells[2, 31].Value = "Width";
                    worksheet.Cells[2, 31].AutoFitColumns(8);

                    worksheet.Cells[2, 32].Value = "Depth";
                    worksheet.Cells[2, 32].AutoFitColumns(8);

                    worksheet.Cells[2, 33].Value = "Depth(%)";
                    worksheet.Cells[2, 33].AutoFitColumns(8);

                    worksheet.Cells[2, 34].Value = "Table(%)";
                    worksheet.Cells[2, 34].AutoFitColumns(8);

                    worksheet.Cells[2, 35].Value = "Key To Symbol";
                    worksheet.Cells[2, 35].AutoFitColumns(25);

                    worksheet.Cells[2, 36].Value = "Comment";
                    worksheet.Cells[2, 36].AutoFitColumns(25);

                    worksheet.Cells[2, 37].Value = "Girdle(%)";
                    worksheet.Cells[2, 37].AutoFitColumns(8);

                    worksheet.Cells[2, 38].Value = "Crown Angle";
                    worksheet.Cells[2, 38].AutoFitColumns(8);

                    worksheet.Cells[2, 39].Value = "Crown Height";
                    worksheet.Cells[2, 39].AutoFitColumns(8);

                    worksheet.Cells[2, 40].Value = "Pavilion Angle";
                    worksheet.Cells[2, 40].AutoFitColumns(8);

                    worksheet.Cells[2, 41].Value = "Pavilion Height";
                    worksheet.Cells[2, 41].AutoFitColumns(8);

                    worksheet.Cells[2, 42].Value = "Table Black";
                    worksheet.Cells[2, 42].AutoFitColumns(8);

                    worksheet.Cells[2, 43].Value = "Crown Black";
                    worksheet.Cells[2, 43].AutoFitColumns(8);

                    worksheet.Cells[2, 44].Value = "Table White";
                    worksheet.Cells[2, 44].AutoFitColumns(8);

                    worksheet.Cells[2, 45].Value = "Crown White";
                    worksheet.Cells[2, 45].AutoFitColumns(8);

                    worksheet.Cells[2, 46].Value = "Culet";
                    worksheet.Cells[2, 46].AutoFitColumns(8);

                    worksheet.Cells[2, 47].Value = "Table Open";
                    worksheet.Cells[2, 47].AutoFitColumns(8);

                    worksheet.Cells[2, 48].Value = "Crown Open";
                    worksheet.Cells[2, 48].AutoFitColumns(8);

                    worksheet.Cells[2, 49].Value = "Pav Open";
                    worksheet.Cells[2, 49].AutoFitColumns(8);

                    worksheet.Cells[2, 50].Value = "Girdle Open";
                    worksheet.Cells[2, 50].AutoFitColumns(8);


                    worksheet.Cells[1, 1].Value = "Total";
                    worksheet.Cells[1, 1, 1, 50].Style.Font.Bold = true;
                    worksheet.Cells[1, 1, 1, 50].Style.Font.Size = 11;
                    worksheet.Cells[1, 1, 1, 50].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    worksheet.Cells[1, 1, 1, 50].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                    worksheet.Cells[1, 1, 1, 50].Style.Font.Size = 11;

                    worksheet.Cells[2, 1, 2, 50].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    worksheet.Cells[2, 1, 2, 50].Style.VerticalAlignment = ExcelVerticalAlignment.Top;
                    worksheet.Cells[2, 1, 2, 50].Style.Font.Size = 10;
                    worksheet.Cells[2, 1, 2, 50].Style.Font.Bold = true;

                    worksheet.Cells[2, 1, 2, 50].AutoFilter = true;

                    var cellBackgroundColor1 = worksheet.Cells[2, 1, 2, 50].Style.Fill;
                    cellBackgroundColor1.PatternType = ExcelFillStyle.Solid;
                    Color colFromHex = System.Drawing.ColorTranslator.FromHtml("#d3d3d3");
                    cellBackgroundColor1.BackgroundColor.SetColor(colFromHex);

                    ExcelStyle cellStyleHeader1 = worksheet.Cells[2, 1, 2, 50].Style;
                    cellStyleHeader1.Border.Left.Style = cellStyleHeader1.Border.Right.Style
                            = cellStyleHeader1.Border.Top.Style = cellStyleHeader1.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
                    ...
                    for (i = inStartIndex; i < inEndCounter; i++)
                    {
                        ...
                        worksheet.Cells[inwrkrow, 7].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["SupplierShortName"]);
                        worksheet.Cells[inwrkrow, 8].Value = "";
                        ...
                        worksheet.Cells[inwrkrow, 26].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Cut"]);
                        if (Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Cut"]).ToUpper() == "3EX")
                        {
                        ...
                        worksheet.Cells[inwrkrow, 30].Value = ((dtDiamonds.Rows[i - inStartIndex]["Length"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["Length"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Length"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 31].Value = ((dtDiamonds.Rows[i - inStartIndex]["Width"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Width"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Width"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 32].Value = ((dtDiamonds.Rows[i - inStartIndex]["Depth"] != null) ?
                                      (dtDiamonds.Rows[i - inStartIndex]["Depth"].GetType().Name != "DBNull" ?
                                      Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Depth"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 33].Value = ((dtDiamonds.Rows[i - inStartIndex]["Depth_Per"] != null) ?
                                      (dtDiamonds.Rows[i - inStartIndex]["Depth_Per"].GetType().Name != "DBNull" ?
                                      Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Depth_Per"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 34].Value = ((dtDiamonds.Rows[i - inStartIndex]["Table_Per"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Table_Per"].GetType().Name != "DBNull" ?
                                       Convert.ToInt32(dtDiamonds.Rows[i - inStartIndex]["Table_Per"]) : ((Int32?)null)) : null);

                        worksheet.Cells[inwrkrow, 35].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Key_To_Symboll"]);
                        worksheet.Cells[inwrkrow, 36].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Lab_Comments"]);

                        worksheet.Cells[inwrkrow, 37].Value = ((dtDiamonds.Rows[i - inStartIndex]["Girdle_Per"] != null) ?
                                      (dtDiamonds.Rows[i - inStartIndex]["Girdle_Per"].GetType().Name != "DBNull" ?
                                      Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Girdle_Per"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 38].Value = ((dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"] != null) ?
                                      (dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"].GetType().Name != "DBNull" ?
                                      Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 39].Value = ((dtDiamonds.Rows[i - inStartIndex]["Crown_Height"] != null) ?
                                      (dtDiamonds.Rows[i - inStartIndex]["Crown_Height"].GetType().Name != "DBNull" ?
                                      Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Crown_Height"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 40].Value = ((dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 41].Value = ((dtDiamonds.Rows[i - inStartIndex]["Pav_Height"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Pav_Height"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Pav_Height"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 42].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Table_Natts"]);
                        worksheet.Cells[inwrkrow, 43].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Crown_Natts"]);
                        worksheet.Cells[inwrkrow, 44].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Table_Inclusion"]);
                        worksheet.Cells[inwrkrow, 45].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Crown_Inclusion"]);
                        worksheet.Cells[inwrkrow, 46].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Culet"]);
                        worksheet.Cells[inwrkrow, 47].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Table_Open"]);
                        worksheet.Cells[inwrkrow, 48].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Crown_Open"]);
                        worksheet.Cells[inwrkrow, 49].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Pav_Open"]);
                        worksheet.Cells[inwrkrow, 50].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Girdle_Open"]);
                    ...
                    worksheet.Cells[inStartIndex, 14, (inwrkrow - 1), 25].Style.Numberformat.Format = "#,##0.00";
                    worksheet.Cells[inStartIndex, 30, (inwrkrow - 1), 33].Style.Numberformat.Format = "0.00";
                    worksheet.Cells[inStartIndex, 34, (inwrkrow - 1), 34].Style.Numberformat.Format = "0";
                    worksheet.Cells[inStartIndex, 37, (inwrkrow - 1), 41].Style.Numberformat.Format = "0.00";

                    worksheet.Cells[inStartIndex, 20, (inwrkrow - 1), 21].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[inStartIndex, 20, (inwrkrow - 1), 21].Style.Fill.BackgroundColor.SetColor(cellBg1);

                    worksheet.Cells[inStartIndex, 22, (inwrkrow - 1), 23].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[inStartIndex, 22, (inwrkrow - 1), 23].Style.Fill.BackgroundColor.SetColor(cellBg);



                    //  "Shape"
                    worksheet.Cells[1, 9].Formula = "ROUND(SUBTOTAL(103," + GetExcelColumnLetter(5) + "" + inStartIndex + ":" + GetExcelColumnLetter(5) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[1, 9].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[1, 9].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[1, 9].Style.Numberformat.Format = "#,##";
                    ExcelStyle cellStyleHeader_Total = worksheet.Cells[1, 9].Style;
                    cellStyleHeader_Total.Border.Left.Style = cellStyleHeader_Total.Border.Right.Style
                            = cellStyleHeader_Total.Border.Top.Style = cellStyleHeader_Total.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Cts"
                    worksheet.Cells[1, 14].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(14) + "" + inStartIndex + ":" + GetExcelColumnLetter(14) + "" + (inwrkrow - 1) + "),2)";
                    ...
                    //  "Rap Amount($)"
                    worksheet.Cells[1, 16].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(16) + "" + inStartIndex + ":" + GetExcelColumnLetter(16) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[1, 16].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[1, 16].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[1, 16].Style.Numberformat.Format = "#,##0";
                    ExcelStyle cellStyleHeader_RapAmt = worksheet.Cells[1, 16].Style;
                    cellStyleHeader_RapAmt.Border.Left.Style = cellStyleHeader_RapAmt.Border.Right.Style
                            = cellStyleHeader_RapAmt.Border.Top.Style = cellStyleHeader_RapAmt.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Supplier Cost Disc(%)"
                    int Rap_Amount = 16, Supplier_Cost_Value_Doller = 21;
                    if (Rap_Amount != 0 && Supplier_Cost_Value_Doller != 0)
                    {
                        worksheet.Cells[1, 20].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(Supplier_Cost_Value_Doller) + "" + inStartIndex + ":" + GetExcelColumnLetter(Supplier_Cost_Value_Doller) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")))*(-100),2))";
                        worksheet.Cells[1, 20].Style.Numberformat.Format = "#,##0.00";
                    ...
                    //  "Final Disc(%)"
                    int Sunrise_Value_US_Doller = 23;
                    if (Rap_Amount != 0 && Sunrise_Value_US_Doller != 0)
                    {
                        worksheet.Cells[1, 22].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ": " + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(Sunrise_Value_US_Doller) + "" + inStartIndex + ":" + GetExcelColumnLetter(Sunrise_Value_US_Doller) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")))*(-100),2))";
                        worksheet.Cells[1, 22].Style.Numberformat.Format = "#,##0.00";
                    ...
                    //  "Supplier Base Offer(%)"
                    int Supplier_Base_Offer_Value_Doller = 25;
                    if (Rap_Amount != 0 && Supplier_Base_Offer_Value_Doller != 0)
                    {
                        worksheet.Cells[1, 24].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(Supplier_Base_Offer_Value_Doller) + "" + inStartIndex + ":" + GetExcelColumnLetter(Supplier_Base_Offer_Value_Doller) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")))*(-100),2))";
                        worksheet.Cells[1, 24].Style.Numberformat.Format = "#,##0.00";
        ...
        public static void Customer_Excel_Old(DataTable dtDiamonds, DataTable Col_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage p = new ExcelPackage())
        ...
        public static void Customer_Excel(DataTable dtDiamonds, DataTable Col_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage p = new ExcelPackage())
                {
                    ...
                    worksheet.Cells[2, 5].Value = "Shape";
                    worksheet.Cells[2, 5].AutoFitColumns(10);

                    worksheet.Cells[2, 6].Value = "Pointer";
                    worksheet.Cells[2, 6].AutoFitColumns(9);

                    worksheet.Cells[2, 7].Value = "BGM";
                    worksheet.Cells[2, 7].AutoFitColumns(9);

                    worksheet.Cells[2, 8].Value = "Color";
                    worksheet.Cells[2, 8].AutoFitColumns(8);

                    worksheet.Cells[2, 9].Value = "Clarity";
                    worksheet.Cells[2, 9].AutoFitColumns(8);

                    worksheet.Cells[2, 10].Value = "Cts";
                    worksheet.Cells[2, 10].AutoFitColumns(8);

                    worksheet.Cells[2, 11].Value = "Rap Rate($)";
                    worksheet.Cells[2, 11].AutoFitColumns(11);

                    worksheet.Cells[2, 12].Value = "Rap Amount($)";
                    worksheet.Cells[2, 12].AutoFitColumns(11);

                    worksheet.Cells[2, 13].Value = "Final Disc(%)";
                    worksheet.Cells[2, 13].AutoFitColumns(10.5);

                    worksheet.Cells[2, 14].Value = "Final Amt US($)";
                    worksheet.Cells[2, 14].AutoFitColumns(11.5);

                    worksheet.Cells[2, 15].Value = "Price / Cts";
                    worksheet.Cells[2, 15].AutoFitColumns(11.5);

                    worksheet.Cells[2, 16].Value = "Cut";
                    worksheet.Cells[2, 16].AutoFitColumns(8);

                    worksheet.Cells[2, 17].Value = "Polish";
                    worksheet.Cells[2, 17].AutoFitColumns(8);

                    worksheet.Cells[2, 18].Value = "Symm";
                    worksheet.Cells[2, 18].AutoFitColumns(8);

                    worksheet.Cells[2, 19].Value = "Fls";
                    worksheet.Cells[2, 19].AutoFitColumns(8);

                    worksheet.Cells[2, 20].Value = "RATIO";
                    worksheet.Cells[2, 20].AutoFitColumns(8);

                    worksheet.Cells[2, 21].Value = "Length";
                    worksheet.Cells[2, 21].AutoFitColumns(8);

                    worksheet.Cells[2, 22].Value = "Width";
                    worksheet.Cells[2, 22].AutoFitColumns(8);

                    worksheet.Cells[2, 23].Value = "Depth";
                    worksheet.Cells[2, 23].AutoFitColumns(8);

                    worksheet.Cells[2, 24].Value = "Depth(%)";
                    worksheet.Cells[2, 24].AutoFitColumns(8);

                    worksheet.Cells[2, 25].Value = "Table(%)";
                    worksheet.Cells[2, 25].AutoFitColumns(8);

                    worksheet.Cells[2, 26].Value = "Key To Symbol";
                    worksheet.Cells[2, 26].AutoFitColumns(25);

                    worksheet.Cells[2, 27].Value = "Comment";
                    worksheet.Cells[2, 27].AutoFitColumns(25);

                    worksheet.Cells[2, 28].Value = "Girdle(%)";
                    worksheet.Cells[2, 28].AutoFitColumns(8);

                    worksheet.Cells[2, 29].Value = "Crown Angle";
                    worksheet.Cells[2, 29].AutoFitColumns(8);

                    worksheet.Cells[2, 30].Value = "Crown Height";
                    worksheet.Cells[2, 30].AutoFitColumns(8);

                    worksheet.Cells[2, 31].Value = "Pav Angle";
                    worksheet.Cells[2, 31].AutoFitColumns(8);

                    worksheet.Cells[2, 32].Value = "Pav Height";
                    worksheet.Cells[2, 32].AutoFitColumns(8);

                    worksheet.Cells[2, 33].Value = "Table Black";
                    worksheet.Cells[2, 33].AutoFitColumns(8);

                    worksheet.Cells[2, 34].Value = "Crown Black";
                    worksheet.Cells[2, 34].AutoFitColumns(8);

                    worksheet.Cells[2, 35].Value = "Table White";
                    worksheet.Cells[2, 35].AutoFitColumns(8);

                    worksheet.Cells[2, 36].Value = "Crown White";
                    worksheet.Cells[2, 36].AutoFitColumns(8);

                    worksheet.Cells[2, 37].Value = "Culet";
                    worksheet.Cells[2, 37].AutoFitColumns(8);

                    worksheet.Cells[2, 38].Value = "Table Open";
                    worksheet.Cells[2, 38].AutoFitColumns(8);

                    worksheet.Cells[2, 39].Value = "Crown Open";
                    worksheet.Cells[2, 39].AutoFitColumns(8);

                    worksheet.Cells[2, 40].Value = "Pavilion Open";
                    worksheet.Cells[2, 40].AutoFitColumns(8);

                    worksheet.Cells[2, 41].Value = "Girdle Open";
                    worksheet.Cells[2, 41].AutoFitColumns(8);


                    worksheet.Cells[1, 1].Value = "Total";
                    worksheet.Cells[1, 1, 1, 41].Style.Font.Bold = true;
                    worksheet.Cells[1, 1, 1, 41].Style.Font.Size = 11;
                    worksheet.Cells[1, 1, 1, 41].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    worksheet.Cells[1, 1, 1, 41].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                    worksheet.Cells[1, 1, 1, 41].Style.Font.Size = 11;

                    worksheet.Cells[2, 1, 2, 41].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    worksheet.Cells[2, 1, 2, 41].Style.VerticalAlignment = ExcelVerticalAlignment.Top;
                    worksheet.Cells[2, 1, 2, 41].Style.Font.Size = 10;
                    worksheet.Cells[2, 1, 2, 41].Style.Font.Bold = true;

                    worksheet.Cells[2, 1, 2, 41].AutoFilter = true;

                    var cellBackgroundColor1 = worksheet.Cells[2, 1, 2, 41].Style.Fill;
                    cellBackgroundColor1.PatternType = ExcelFillStyle.Solid;
                    Color colFromHex = System.Drawing.ColorTranslator.FromHtml("#d3d3d3");
                    cellBackgroundColor1.BackgroundColor.SetColor(colFromHex);

                    ExcelStyle cellStyleHeader1 = worksheet.Cells[2, 1, 2, 41].Style;
                    cellStyleHeader1.Border.Left.Style = cellStyleHeader1.Border.Right.Style
                            = cellStyleHeader1.Border.Top.Style = cellStyleHeader1.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
                    ...
                    for (i = inStartIndex; i < inEndCounter; i++)
                    {
                        ...
                        worksheet.Cells[inwrkrow, 7].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["BGM"]);
                        worksheet.Cells[inwrkrow, 8].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Color"]);
                        worksheet.Cells[inwrkrow, 9].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Clarity"]);

                        worksheet.Cells[inwrkrow, 10].Value = ((dtDiamonds.Rows[i - inStartIndex]["Cts"] != null) ?
                                      (dtDiamonds.Rows[i - inStartIndex]["Cts"].GetType().Name != "DBNull" ?
                                      Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Cts"]) : ((Double?)null)) : null);
                        //worksheet.Cells[inwrkrow, 10].Style.Numberformat.Format = "#,##0.00";

                        worksheet.Cells[inwrkrow, 11].Value = ((dtDiamonds.Rows[i - inStartIndex]["Rap_Rate"] != null) ?
                                     (dtDiamonds.Rows[i - inStartIndex]["Rap_Rate"].GetType().Name != "DBNull" ?
                                     Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Rap_Rate"]) : ((Double?)null)) : null);
                        //worksheet.Cells[inwrkrow, 11].Style.Numberformat.Format = "#,##0.00";

                        worksheet.Cells[inwrkrow, 12].Value = ((dtDiamonds.Rows[i - inStartIndex]["Rap_Amount"] != null) ?
                                    (dtDiamonds.Rows[i - inStartIndex]["Rap_Amount"].GetType().Name != "DBNull" ?
                                    Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Rap_Amount"]) : ((Double?)null)) : null);
                        //worksheet.Cells[inwrkrow, 12].Style.Numberformat.Format = "#,##0.00";


                        //worksheet.Cells[inwrkrow, 13].Value = ((dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_DISC"] != null) ?
                        //             (dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_DISC"].GetType().Name != "DBNull" ?
                        //             Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_DISC"]) : ((Double?)null)) : null);
                        worksheet.Cells[inwrkrow, 13].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(12) + "" + inwrkrow + ":" + GetExcelColumnLetter(12) + "" + inwrkrow + ")=0,0,ROUND((1-(" + GetExcelColumnLetter(14) + "" + inwrkrow + "/" + GetExcelColumnLetter(12) + "" + inwrkrow + "))*(-100),2))";
                        worksheet.Cells[inwrkrow, 13].Style.Numberformat.Format = "#,##0.00";


                        //worksheet.Cells[inwrkrow, 13].Style.Numberformat.Format = "#,##0.00";
                        //worksheet.Cells[inwrkrow, 13].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        //worksheet.Cells[inwrkrow, 13].Style.Fill.BackgroundColor.SetColor(cellBg);

                        worksheet.Cells[inwrkrow, 14].Value = ((dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_VALUE"] != null) ?
                                     (dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_VALUE"].GetType().Name != "DBNull" ?
                                     Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_VALUE"]) : ((Double?)null)) : null);

                        //worksheet.Cells[inwrkrow, 14].Style.Numberformat.Format = "#,##0.00";
                        //worksheet.Cells[inwrkrow, 14].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        //worksheet.Cells[inwrkrow, 14].Style.Fill.BackgroundColor.SetColor(cellBg);


                        //worksheet.Cells[inwrkrow, 15].Value = ((dtDiamonds.Rows[i - inStartIndex]["Base_Price_Cts"] != null) ?
                        //            (dtDiamonds.Rows[i - inStartIndex]["Base_Price_Cts"].GetType().Name != "DBNull" ?
                        //            Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Base_Price_Cts"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 15].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(14) + "" + inwrkrow + ":" + GetExcelColumnLetter(14) + "" + inwrkrow + ")=0,0,ROUND(" + GetExcelColumnLetter(14) + "" + inwrkrow + "/" + GetExcelColumnLetter(10) + "" + inwrkrow + ",2))";
                        worksheet.Cells[inwrkrow, 15].Style.Numberformat.Format = "#,##0.00";

                        //worksheet.Cells[inwrkrow, 15].Style.Numberformat.Format = "#,##0.00";
                        //worksheet.Cells[inwrkrow, 15].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        //worksheet.Cells[inwrkrow, 15].Style.Fill.BackgroundColor.SetColor(ppc_bg);

                        worksheet.Cells[inwrkrow, 16].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Cut"]);
                        if (Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Cut"]).ToUpper() == "3EX")
                        {
                            worksheet.Cells[inwrkrow, 16].Style.Font.Bold = true;
                        }

                        worksheet.Cells[inwrkrow, 17].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Polish"]);
                        if (Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Cut"]).ToUpper() == "3EX")
                        {
                            worksheet.Cells[inwrkrow, 17].Style.Font.Bold = true;
                        }

                        worksheet.Cells[inwrkrow, 18].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Symm"]);
                        if (Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Cut"]).ToUpper() == "3EX")
                        {
                            worksheet.Cells[inwrkrow, 18].Style.Font.Bold = true;
                        }

                        worksheet.Cells[inwrkrow, 19].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Fls"]);

                        worksheet.Cells[inwrkrow, 20].Value = ((dtDiamonds.Rows[i - inStartIndex]["RATIO"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["RATIO"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["RATIO"]) : ((Double?)null)) : null);
                        //worksheet.Cells[inwrkrow, 20].Style.Numberformat.Format = "0.00";
                        //worksheet.Cells[inwrkrow, 20].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        //worksheet.Cells[inwrkrow, 20].Style.Fill.BackgroundColor.SetColor(ratio_bg);

                        worksheet.Cells[inwrkrow, 21].Value = ((dtDiamonds.Rows[i - inStartIndex]["Length"] != null) ?
                                      (dtDiamonds.Rows[i - inStartIndex]["Length"].GetType().Name != "DBNull" ?
                                      Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Length"]) : ((Double?)null)) : null);
                        //worksheet.Cells[inwrkrow, 21].Style.Numberformat.Format = "0.00";

                        worksheet.Cells[inwrkrow, 22].Value = ((dtDiamonds.Rows[i - inStartIndex]["Width"] != null) ?
                           (dtDiamonds.Rows[i - inStartIndex]["Width"].GetType().Name != "DBNull" ?
                           Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Width"]) : ((Double?)null)) : null);
                        //worksheet.Cells[inwrkrow, 22].Style.Numberformat.Format = "0.00";

                        worksheet.Cells[inwrkrow, 23].Value = ((dtDiamonds.Rows[i - inStartIndex]["Depth"] != null) ?
                          (dtDiamonds.Rows[i - inStartIndex]["Depth"].GetType().Name != "DBNull" ?
                          Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Depth"]) : ((Double?)null)) : null);
                        //worksheet.Cells[inwrkrow, 23].Style.Numberformat.Format = "0.00";

                        worksheet.Cells[inwrkrow, 24].Value = ((dtDiamonds.Rows[i - inStartIndex]["Depth_Per"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Depth_Per"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Depth_Per"]) : ((Double?)null)) : null);
                        //worksheet.Cells[inwrkrow, 24].Style.Numberformat.Format = "0.00";

                        worksheet.Cells[inwrkrow, 25].Value = ((dtDiamonds.Rows[i - inStartIndex]["Table_Per"] != null) ?
                           (dtDiamonds.Rows[i - inStartIndex]["Table_Per"].GetType().Name != "DBNull" ?
                           Convert.ToInt32(dtDiamonds.Rows[i - inStartIndex]["Table_Per"]) : ((Int32?)null)) : null);
                        //worksheet.Cells[inwrkrow, 25].Style.Numberformat.Format = "0";

                        worksheet.Cells[inwrkrow, 26].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Key_To_Symboll"]);
                        worksheet.Cells[inwrkrow, 27].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Lab_Comments"]);

                        worksheet.Cells[inwrkrow, 28].Value = ((dtDiamonds.Rows[i - inStartIndex]["Girdle_Per"] != null) ?
                                      (dtDiamonds.Rows[i - inStartIndex]["Girdle_Per"].GetType().Name != "DBNull" ?
                                      Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Girdle_Per"]) : ((Double?)null)) : null);
                        //worksheet.Cells[inwrkrow, 28].Style.Numberformat.Format = "0.00";

                        worksheet.Cells[inwrkrow, 29].Value = ((dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"] != null) ?
                                      (dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"].GetType().Name != "DBNull" ?
                                      Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"]) : ((Double?)null)) : null);
                        //worksheet.Cells[inwrkrow, 29].Style.Numberformat.Format = "0.00";

                        worksheet.Cells[inwrkrow, 30].Value = ((dtDiamonds.Rows[i - inStartIndex]["Crown_Height"] != null) ?
                          (dtDiamonds.Rows[i - inStartIndex]["Crown_Height"].GetType().Name != "DBNull" ?
                          Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Crown_Height"]) : ((Double?)null)) : null);
                        //worksheet.Cells[inwrkrow, 30].Style.Numberformat.Format = "0.00";

                        worksheet.Cells[inwrkrow, 31].Value = ((dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"] != null) ?
                           (dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"].GetType().Name != "DBNull" ?
                           Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"]) : ((Double?)null)) : null);
                        //worksheet.Cells[inwrkrow, 31].Style.Numberformat.Format = "0.00";

                        worksheet.Cells[inwrkrow, 32].Value = ((dtDiamonds.Rows[i - inStartIndex]["Pav_Height"] != null) ?
                           (dtDiamonds.Rows[i - inStartIndex]["Pav_Height"].GetType().Name != "DBNull" ?
                           Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Pav_Height"]) : ((Double?)null)) : null);
                        //worksheet.Cells[inwrkrow, 32].Style.Numberformat.Format = "0.00";

                        worksheet.Cells[inwrkrow, 33].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Table_Natts"]);
                        worksheet.Cells[inwrkrow, 34].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Crown_Natts"]);
                        worksheet.Cells[inwrkrow, 35].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Table_Inclusion"]);
                        worksheet.Cells[inwrkrow, 36].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Crown_Inclusion"]);
                        worksheet.Cells[inwrkrow, 37].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Culet"]);
                        worksheet.Cells[inwrkrow, 38].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Table_Open"]);
                        worksheet.Cells[inwrkrow, 39].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Crown_Open"]);
                        worksheet.Cells[inwrkrow, 40].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Pav_Open"]);
                    ...
                    worksheet.Cells[inStartIndex, 10, (inwrkrow - 1), 15].Style.Numberformat.Format = "#,##0.00";
                    worksheet.Cells[inStartIndex, 20, (inwrkrow - 1), 24].Style.Numberformat.Format = "0.00";
                    worksheet.Cells[inStartIndex, 25, (inwrkrow - 1), 25].Style.Numberformat.Format = "0";
                    ...
                    //  "Ref No"
                    worksheet.Cells[1, 1].Formula = "ROUND(SUBTOTAL(103," + GetExcelColumnLetter(1) + "" + inStartIndex + ":" + GetExcelColumnLetter(1) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[1, 1].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[1, 1].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[1, 1].Style.Numberformat.Format = "#,##";
                    ExcelStyle cellStyleHeader_Total = worksheet.Cells[1, 1].Style;
                    cellStyleHeader_Total.Border.Left.Style = cellStyleHeader_Total.Border.Right.Style
                            = cellStyleHeader_Total.Border.Top.Style = cellStyleHeader_Total.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Cts"
                    worksheet.Cells[1, 10].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(10) + "" + inStartIndex + ":" + GetExcelColumnLetter(10) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[1, 10].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[1, 10].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[1, 10].Style.Numberformat.Format = "#,##0.00";
                    ExcelStyle cellStyleHeader_Totalcarat = worksheet.Cells[1, 10].Style;
                    cellStyleHeader_Totalcarat.Border.Left.Style = cellStyleHeader_Totalcarat.Border.Right.Style
                            = cellStyleHeader_Totalcarat.Border.Top.Style = cellStyleHeader_Totalcarat.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Final Disc(%)"
                    int Rap_Amount = 12, Offer_Value_Doller = 14;
                    if (Rap_Amount != 0 && Offer_Value_Doller != 0)
                    {
                        worksheet.Cells[1, 13].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(Offer_Value_Doller) + "" + inStartIndex + ":" + GetExcelColumnLetter(Offer_Value_Doller) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(Rap_Amount) + "" + inStartIndex + ":" + GetExcelColumnLetter(Rap_Amount) + "" + (inwrkrow - 1) + ")))*(-100),2))";
                        worksheet.Cells[1, 13].Style.Numberformat.Format = "#,##0.00";
                        ExcelStyle cellStyleHeader_TotalDis = worksheet.Cells[1, 13].Style;
                        cellStyleHeader_TotalDis.Border.Left.Style = cellStyleHeader_TotalDis.Border.Right.Style
                                = cellStyleHeader_TotalDis.Border.Top.Style = cellStyleHeader_TotalDis.Border.Bottom.Style
                                = ExcelBorderStyle.Medium;
                    }
                    ...
                    worksheet.Cells[1, 14].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[1, 14].Style.Numberformat.Format = "#,##0.00";
                    ExcelStyle cellStyleHeader_TotalAmt = worksheet.Cells[1, 14].Style;
                    cellStyleHeader_TotalAmt.Border.Left.Style = cellStyleHeader_TotalAmt.Border.Right.Style
                            = cellStyleHeader_TotalAmt.Border.Top.Style = cellStyleHeader_TotalAmt.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    //  "Rap Amount($)"
                    worksheet.Cells[1, 12].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(12) + "" + inStartIndex + ":" + GetExcelColumnLetter(12) + "" + (inwrkrow - 1) + "),2)";
                    ...
                    worksheet.Cells[1, 12].Style.Numberformat.Format = "#,##0";
                    ExcelStyle cellStyleHeader_RapAmt = worksheet.Cells[1, 12].Style;
                    cellStyleHeader_RapAmt.Border.Left.Style = cellStyleHeader_RapAmt.Border.Right.Style
                            = cellStyleHeader_RapAmt.Border.Top.Style = cellStyleHeader_RapAmt.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
        ...
        public static void LabEntry_Excel(DataTable dtDiamonds, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage p = new ExcelPackage())
                {
                    ...
                    worksheet.Cells[3, 40].Value = "Table Black";
                    worksheet.Cells[3, 41].Value = "Crown Black";
                    worksheet.Cells[3, 42].Value = "Table White";
                    worksheet.Cells[3, 43].Value = "Crown White";
                    ...
                    worksheet.Cells[3, 1].AutoFitColumns(12);           //"Ref No";
                    worksheet.Cells[3, 2].AutoFitColumns(8);            //"Lab";
                    worksheet.Cells[3, 3].AutoFitColumns(7);            //"Image";
                    worksheet.Cells[3, 4].AutoFitColumns(7);            //"Video";
                    worksheet.Cells[3, 5].AutoFitColumns(13);           //"Supplier Stone Id";
                    worksheet.Cells[3, 6].AutoFitColumns(13);           //"Certificate No";
                    worksheet.Cells[3, 7].AutoFitColumns(27);           //"Supplier Name";
                    worksheet.Cells[3, 8].AutoFitColumns(27);           //"Company Name";
                    worksheet.Cells[3, 9].AutoFitColumns(10);           //"Shape";
                    worksheet.Cells[3, 10].AutoFitColumns(9);           //"Pointer";
                    worksheet.Cells[3, 11].AutoFitColumns(9);           //"BGM";
                    worksheet.Cells[3, 12].AutoFitColumns(8);           //"Color";
                    worksheet.Cells[3, 13].AutoFitColumns(8);           //"Clarity";
                    worksheet.Cells[3, 14].AutoFitColumns(8);           //"Cts";
                    worksheet.Cells[3, 15].AutoFitColumns(11);          //"Rap Rate($)";
                    worksheet.Cells[3, 16].AutoFitColumns(11);          //"Rap Amount($)";
                    worksheet.Cells[3, 17].AutoFitColumns(11.5);          //"Supplier Cost Disc(%)";
                    worksheet.Cells[3, 18].AutoFitColumns(11.5);          //"Supplier Cost Value($)";
                    worksheet.Cells[3, 19].AutoFitColumns(11.5);          //"Final Disc(%)";
                    worksheet.Cells[3, 20].AutoFitColumns(11.5);          //"Final Amt US($)";
                    worksheet.Cells[3, 21].AutoFitColumns(11.5);          //"Profit Amount($)";
                    worksheet.Cells[3, 22].AutoFitColumns(11.5);          //"Profit(%)";
                    worksheet.Cells[3, 23].AutoFitColumns(11.5);          //"Supplier Base Offer Disc(%)";
                    worksheet.Cells[3, 24].AutoFitColumns(11.5);          //"Supplier Base Value($)";
                    worksheet.Cells[3, 25].AutoFitColumns(8);           //"Cut";
                    worksheet.Cells[3, 26].AutoFitColumns(8);           //"Polish";
                    worksheet.Cells[3, 27].AutoFitColumns(8);           //"Symm";
                    worksheet.Cells[3, 28].AutoFitColumns(8);           //"Fls";
                    worksheet.Cells[3, 29].AutoFitColumns(8);         //"Length";
                    worksheet.Cells[3, 30].AutoFitColumns(8);         //"Width";
                    worksheet.Cells[3, 31].AutoFitColumns(8);         //"Depth";
                    worksheet.Cells[3, 32].AutoFitColumns(8);         //"Depth (%)";
                    worksheet.Cells[3, 33].AutoFitColumns(8);         //"Table (%)";
                    worksheet.Cells[3, 34].AutoFitColumns(25);          //"Key To Symbol";
                    worksheet.Cells[3, 35].AutoFitColumns(8);         //"Girdle(%)";
                    worksheet.Cells[3, 36].AutoFitColumns(8);           //"Crown Angle";
                    worksheet.Cells[3, 37].AutoFitColumns(8);           //"Crown Height";
                    worksheet.Cells[3, 38].AutoFitColumns(8);           //"Pav Angle";
                    worksheet.Cells[3, 39].AutoFitColumns(8);           //"Pav Height";
                    worksheet.Cells[3, 40].AutoFitColumns(8);           //"Table Black";
                    worksheet.Cells[3, 41].AutoFitColumns(8);           //"Crown Black";
                    worksheet.Cells[3, 42].AutoFitColumns(8);           //"Table White";
                    worksheet.Cells[3, 43].AutoFitColumns(8);           //"Crown White";
                    worksheet.Cells[3, 44].AutoFitColumns(8);           //"Table Open";
                    worksheet.Cells[3, 45].AutoFitColumns(8);           //"Crown Open";
                    worksheet.Cells[3, 46].AutoFitColumns(8);           //"Pavilion Open";
                    worksheet.Cells[3, 47].AutoFitColumns(8);           //"Girdle Open";
                    worksheet.Cells[3, 48].AutoFitColumns(8);           //"Culet";
                    ...
                    worksheet.Cells[2, 16].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(16) + "" + inStartIndex + ":" + GetExcelColumnLetter(16) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[2, 16].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[2, 16].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[2, 16].Style.Numberformat.Format = "#,##0";

                    ExcelStyle cellStyleHeader_TotalRapAmt = worksheet.Cells[2, 16].Style;
                    cellStyleHeader_TotalRapAmt.Border.Left.Style = cellStyleHeader_TotalRapAmt.Border.Right.Style
                            = cellStyleHeader_TotalRapAmt.Border.Top.Style = cellStyleHeader_TotalRapAmt.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
        ...
        public static void LabEntryReport_Excel(DataTable dtDiamonds, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage p = new ExcelPackage())
                {
                    ...
                    //p.Workbook.Properties.Author = "SUNRISE DIAMOND";
                    //p.Workbook.Properties.Title = "SUNRISE DIAMOND PVT. LTD.";
                    p.Workbook.Worksheets.Add("Lab Entry Report");
                    ...
                    worksheet.Cells[2, 1].Value = "Total";
                    worksheet.Cells[2, 1, 2, 54].Style.Font.Bold = true;
                    worksheet.Cells[2, 1, 2, 54].Style.Font.Size = 11;
                    worksheet.Cells[2, 1, 2, 54].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    worksheet.Cells[2, 1, 2, 54].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                    worksheet.Cells[2, 1, 2, 54].Style.Font.Size = 11;

                    worksheet.Cells[3, 1, 3, 54].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    worksheet.Cells[3, 1, 3, 54].Style.VerticalAlignment = ExcelVerticalAlignment.Top;
                    worksheet.Cells[3, 1, 3, 54].Style.Font.Size = 10;
                    worksheet.Cells[3, 1, 3, 54].Style.Font.Bold = true;

                    worksheet.Cells[3, 1, 3, 54].AutoFilter = true;

                    var cellBackgroundColor1 = worksheet.Cells[3, 1, 3, 54].Style.Fill;
                    cellBackgroundColor1.PatternType = ExcelFillStyle.Solid;
                    Color colFromHex = System.Drawing.ColorTranslator.FromHtml("#d3d3d3");
                    cellBackgroundColor1.BackgroundColor.SetColor(colFromHex);
                    ...
                    worksheet.Cells[3, 3].Value = "Lab Entry Date";
                    worksheet.Cells[3, 3].AutoFitColumns(12);

                    worksheet.Cells[3, 4].Value = "Lab No";
                    worksheet.Cells[3, 4].AutoFitColumns(9);

                    worksheet.Cells[3, 5].Value = "User Name";
                    worksheet.Cells[3, 5].AutoFitColumns(20);

                    worksheet.Cells[3, 6].Value = "Customer Name";
                    worksheet.Cells[3, 6].AutoFitColumns(20);

                    worksheet.Cells[3, 7].Value = "Company Name";
                    worksheet.Cells[3, 7].AutoFitColumns(27);

                    worksheet.Cells[3, 8].Value = "Ref No";
                    worksheet.Cells[3, 8].AutoFitColumns(12);

                    worksheet.Cells[3, 9].Value = "QC Require";
                    worksheet.Cells[3, 9].AutoFitColumns(25);

                    worksheet.Cells[3, 10].Value = "Lab Entry Status";
                    worksheet.Cells[3, 10].AutoFitColumns(12);

                    worksheet.Cells[3, 11].Value = "Lab";
                    worksheet.Cells[3, 11].AutoFitColumns(8);

                    worksheet.Cells[3, 12].Value = "Supplier Stone Id";
                    worksheet.Cells[3, 12].AutoFitColumns(13);

                    worksheet.Cells[3, 13].Value = "Certificate No";
                    worksheet.Cells[3, 13].AutoFitColumns(13);

                    worksheet.Cells[3, 14].Value = "Supplier Name";
                    worksheet.Cells[3, 14].AutoFitColumns(27);

                    worksheet.Cells[3, 15].Value = "Shape";
                    worksheet.Cells[3, 15].AutoFitColumns(10);

                    worksheet.Cells[3, 16].Value = "Pointer";
                    worksheet.Cells[3, 16].AutoFitColumns(9);

                    worksheet.Cells[3, 17].Value = "BGM";
                    worksheet.Cells[3, 17].AutoFitColumns(9);

                    worksheet.Cells[3, 18].Value = "Color";
                    worksheet.Cells[3, 18].AutoFitColumns(8);

                    worksheet.Cells[3, 19].Value = "Clarity";
                    worksheet.Cells[3, 19].AutoFitColumns(8);

                    worksheet.Cells[3, 20].Value = "Cts";
                    worksheet.Cells[3, 20].AutoFitColumns(8);

                    worksheet.Cells[3, 21].Value = "Rap Rate($)";
                    worksheet.Cells[3, 21].AutoFitColumns(11);

                    worksheet.Cells[3, 22].Value = "Rap Amount($)";
                    worksheet.Cells[3, 22].AutoFitColumns(11);

                    worksheet.Cells[3, 23].Value = "Supplier Cost Disc(%)";
                    worksheet.Cells[3, 23].AutoFitColumns(11.5);

                    worksheet.Cells[3, 24].Value = "Supplier Cost Value($)";
                    worksheet.Cells[3, 24].AutoFitColumns(11.5);

                    worksheet.Cells[3, 25].Value = "Final Disc(%)";
                    worksheet.Cells[3, 25].AutoFitColumns(11.5);

                    worksheet.Cells[3, 26].Value = "Final Amt US($)";
                    worksheet.Cells[3, 26].AutoFitColumns(11.5);

                    worksheet.Cells[3, 27].Value = "Profit Amount($)";
                    worksheet.Cells[3, 27].AutoFitColumns(11.5);

                    worksheet.Cells[3, 28].Value = "Profit(%)";
                    worksheet.Cells[3, 28].AutoFitColumns(11.5);

                    worksheet.Cells[3, 29].Value = "Supplier Base Offer Disc(%)";
                    worksheet.Cells[3, 29].AutoFitColumns(11.5);

                    worksheet.Cells[3, 30].Value = "Supplier Base Value($)";
                    worksheet.Cells[3, 30].AutoFitColumns(11.5);

                    worksheet.Cells[3, 31].Value = "Cut";
                    worksheet.Cells[3, 31].AutoFitColumns(8);

                    worksheet.Cells[3, 32].Value = "Polish";
                    worksheet.Cells[3, 32].AutoFitColumns(8);

                    worksheet.Cells[3, 33].Value = "Symm";
                    worksheet.Cells[3, 33].AutoFitColumns(8);

                    worksheet.Cells[3, 34].Value = "Fls";
                    worksheet.Cells[3, 34].AutoFitColumns(8);

                    worksheet.Cells[3, 35].Value = "Length";
                    worksheet.Cells[3, 35].AutoFitColumns(8);

                    worksheet.Cells[3, 36].Value = "Width";
                    worksheet.Cells[3, 36].AutoFitColumns(8);

                    worksheet.Cells[3, 37].Value = "Depth";
                    worksheet.Cells[3, 37].AutoFitColumns(8);

                    worksheet.Cells[3, 38].Value = "Depth (%)";
                    worksheet.Cells[3, 38].AutoFitColumns(8);

                    worksheet.Cells[3, 39].Value = "Table (%)";
                    worksheet.Cells[3, 39].AutoFitColumns(8);

                    worksheet.Cells[3, 40].Value = "Key To Symbol";
                    worksheet.Cells[3, 40].AutoFitColumns(25);

                    worksheet.Cells[3, 41].Value = "Girdle(%)";
                    worksheet.Cells[3, 41].AutoFitColumns(8);

                    worksheet.Cells[3, 42].Value = "Crown Angle";
                    worksheet.Cells[3, 42].AutoFitColumns(8);

                    worksheet.Cells[3, 43].Value = "Crown Height";
                    worksheet.Cells[3, 43].AutoFitColumns(8);

                    worksheet.Cells[3, 44].Value = "Pav Angle";
                    worksheet.Cells[3, 44].AutoFitColumns(8);

                    worksheet.Cells[3, 45].Value = "Pav Height";
                    worksheet.Cells[3, 45].AutoFitColumns(8);

                    worksheet.Cells[3, 46].Value = "Table Black";
                    worksheet.Cells[3, 46].AutoFitColumns(8);

                    worksheet.Cells[3, 47].Value = "Crown Black";
                    worksheet.Cells[3, 47].AutoFitColumns(8);

                    worksheet.Cells[3, 48].Value = "Table White";
                    worksheet.Cells[3, 48].AutoFitColumns(8);

                    worksheet.Cells[3, 49].Value = "Crown White";
                    worksheet.Cells[3, 49].AutoFitColumns(8);

                    worksheet.Cells[3, 50].Value = "Table Open";
                    worksheet.Cells[3, 50].AutoFitColumns(8);

                    worksheet.Cells[3, 51].Value = "Crown Open";
                    worksheet.Cells[3, 51].AutoFitColumns(8);

                    worksheet.Cells[3, 52].Value = "Pavilion Open";
                    worksheet.Cells[3, 52].AutoFitColumns(8);

                    worksheet.Cells[3, 53].Value = "Girdle Open";
                    worksheet.Cells[3, 53].AutoFitColumns(8);

                    worksheet.Cells[3, 54].Value = "Culet";
                    worksheet.Cells[3, 54].AutoFitColumns(8);

                    ExcelStyle cellStyleHeader1 = worksheet.Cells[3, 1, 3, 54].Style;
                    cellStyleHeader1.Border.Left.Style = cellStyleHeader1.Border.Right.Style
                            = cellStyleHeader1.Border.Top.Style = cellStyleHeader1.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
                    ...
                    //Set Cell Faoat value with Alignment
                    worksheet.Cells[inStartIndex, 1, inEndCounter, 54].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    ...
                    for (i = inStartIndex; i < inEndCounter; i++)
                    {
                        ...
                        worksheet.Cells[inwrkrow, 3].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["LabDate"]);

                        worksheet.Cells[inwrkrow, 4].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["LabId"]);

                        worksheet.Cells[inwrkrow, 5].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Entry_UserName"]);

                        worksheet.Cells[inwrkrow, 6].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["CustName"]);

                        worksheet.Cells[inwrkrow, 7].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["CompName"]);

                        worksheet.Cells[inwrkrow, 8].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Ref_No"]);

                        worksheet.Cells[inwrkrow, 9].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["QCRequire"]);

                        worksheet.Cells[inwrkrow, 10].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["LabEntry_Status"]);
                        ...
                        if (URL != "")
                        {
                            worksheet.Cells[inwrkrow, 11].Formula = "=HYPERLINK(\"" + Convert.ToString(URL) + "\",\" " + Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Lab"]) + " \")";
                            worksheet.Cells[inwrkrow, 11].Style.Font.UnderLine = true;
                            worksheet.Cells[inwrkrow, 11].Style.Font.Color.SetColor(Color.Blue);
                        }

                        worksheet.Cells[inwrkrow, 12].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Supplier_Stone_Id"]);

                        worksheet.Cells[inwrkrow, 12].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Certificate_No"]);

                        worksheet.Cells[inwrkrow, 14].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["SupplierName"]);

                        worksheet.Cells[inwrkrow, 15].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Shape"]);

                        worksheet.Cells[inwrkrow, 16].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Pointer"]);
                        ...
                        worksheet.Cells[inwrkrow, 21].Value = ((dtDiamonds.Rows[i - inStartIndex]["Rap_Rate"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Rap_Rate"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Rap_Rate"]) : ((Double?)null)) : null);
                        ...
                        worksheet.Cells[inwrkrow, 25].Value = ((dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_DISC"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_DISC"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_DISC"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 26].Value = ((dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_VALUE"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_VALUE"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_VALUE"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 27].Value = ((dtDiamonds.Rows[i - inStartIndex]["PROFIT"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["PROFIT"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["PROFIT"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 28].Value = ((dtDiamonds.Rows[i - inStartIndex]["PROFIT_AMOUNT"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["PROFIT_AMOUNT"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["PROFIT_AMOUNT"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 29].Value = ((dtDiamonds.Rows[i - inStartIndex]["Disc"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Disc"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Disc"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 30].Value = ((dtDiamonds.Rows[i - inStartIndex]["Value"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Value"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Value"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 31].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Cut"]);

                        worksheet.Cells[inwrkrow, 32].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Polish"]);

                        worksheet.Cells[inwrkrow, 33].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Symm"]);

                        worksheet.Cells[inwrkrow, 34].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Fls"]);

                        worksheet.Cells[inwrkrow, 35].Value = ((dtDiamonds.Rows[i - inStartIndex]["Length"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Length"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Length"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 36].Value = ((dtDiamonds.Rows[i - inStartIndex]["Width"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Width"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Width"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 37].Value = ((dtDiamonds.Rows[i - inStartIndex]["Depth"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Depth"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Depth"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 38].Value = ((dtDiamonds.Rows[i - inStartIndex]["Depth_Per"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Depth_Per"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Depth_Per"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 39].Value = ((dtDiamonds.Rows[i - inStartIndex]["Table_Per"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Table_Per"].GetType().Name != "DBNull" ?
                                       Convert.ToInt32(dtDiamonds.Rows[i - inStartIndex]["Table_Per"]) : ((Int32?)null)) : null);

                        worksheet.Cells[inwrkrow, 40].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Key_To_Symboll"]);

                        worksheet.Cells[inwrkrow, 41].Value = ((dtDiamonds.Rows[i - inStartIndex]["Girdle_Per"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Girdle_Per"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Girdle_Per"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 42].Value = ((dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 43].Value = ((dtDiamonds.Rows[i - inStartIndex]["Crown_Height"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Crown_Height"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Crown_Height"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 44].Value = ((dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 45].Value = ((dtDiamonds.Rows[i - inStartIndex]["Pav_Height"] != null) ?
                                       (dtDiamonds.Rows[i - inStartIndex]["Pav_Height"].GetType().Name != "DBNull" ?
                                       Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Pav_Height"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 46].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Table_Natts"]);

                        worksheet.Cells[inwrkrow, 47].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Crown_Natts"]);

                        worksheet.Cells[inwrkrow, 48].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Table_Inclusion"]);

                        worksheet.Cells[inwrkrow, 49].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Crown_Inclusion"]);

                        worksheet.Cells[inwrkrow, 50].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Table_Open"]);

                        worksheet.Cells[inwrkrow, 51].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Crown_Open"]);

                        worksheet.Cells[inwrkrow, 52].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Pav_Open"]);

                        worksheet.Cells[inwrkrow, 53].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Girdle_Open"]);

                        worksheet.Cells[inwrkrow, 54].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Culet"]);
                    ...
                    worksheet.Cells[inStartIndex, 1, (inwrkrow - 1), 54].Style.Font.Size = 9;
                    worksheet.Cells[inStartIndex, 23, (inwrkrow - 1), 26].Style.Font.Bold = true;
                    worksheet.Cells[inStartIndex, 19, (inwrkrow - 1), 30].Style.Font.Bold = true;

                    worksheet.Cells[inStartIndex, 20, (inwrkrow - 1), 20].Style.Numberformat.Format = "0.00";
                    worksheet.Cells[inStartIndex, 21, (inwrkrow - 1), 30].Style.Numberformat.Format = "#,##0.00";

                    worksheet.Cells[inStartIndex, 35, (inwrkrow - 1), 38].Style.Numberformat.Format = "0.00";
                    worksheet.Cells[inStartIndex, 41, (inwrkrow - 1), 45].Style.Numberformat.Format = "0.00";

                    worksheet.Cells[inStartIndex, 23, (inwrkrow - 1), 24].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[inStartIndex, 23, (inwrkrow - 1), 24].Style.Fill.BackgroundColor.SetColor(cellBg1);

                    worksheet.Cells[inStartIndex, 25, (inwrkrow - 1), 26].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[inStartIndex, 25, (inwrkrow - 1), 26].Style.Fill.BackgroundColor.SetColor(cellBg);

                    worksheet.Cells[2, 8].Formula = "ROUND(SUBTOTAL(102," + GetExcelColumnLetter(20) + "" + inStartIndex + ":" + GetExcelColumnLetter(20) + "" + (inwrkrow - 1) + "),2)";
                    ...
                    worksheet.Cells[2, 8].Style.Numberformat.Format = "#,##";

                    ExcelStyle cellStyleHeader_Total = worksheet.Cells[2, 8].Style;
                    cellStyleHeader_Total.Border.Left.Style = cellStyleHeader_Total.Border.Right.Style
                            = cellStyleHeader_Total.Border.Top.Style = cellStyleHeader_Total.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
                    ...
                    ExcelStyle cellStyleHeader_Totalcarat = worksheet.Cells[2, 20].Style;
                    cellStyleHeader_Totalcarat.Border.Left.Style = cellStyleHeader_Totalcarat.Border.Right.Style
                            = cellStyleHeader_Totalcarat.Border.Top.Style = cellStyleHeader_Totalcarat.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;


                    worksheet.Cells[2, 22].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(22) + "" + inStartIndex + ":" + GetExcelColumnLetter(22) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[2, 22].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[2, 22].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[2, 22].Style.Numberformat.Format = "#,##0";

                    ExcelStyle cellStyleHeader_TotalRapAmt = worksheet.Cells[2, 22].Style;
                    cellStyleHeader_TotalRapAmt.Border.Left.Style = cellStyleHeader_TotalRapAmt.Border.Right.Style
                            = cellStyleHeader_TotalRapAmt.Border.Top.Style = cellStyleHeader_TotalRapAmt.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;


                    worksheet.Cells[2, 23].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(22) + "" + inStartIndex + ": " + GetExcelColumnLetter(22) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(24) + "" + inStartIndex + ":" + GetExcelColumnLetter(24) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(22) + "" + inStartIndex + ":" + GetExcelColumnLetter(22) + "" + (inwrkrow - 1) + ")))*(-100),2))";
                    worksheet.Cells[2, 23].Style.Numberformat.Format = "#,##0.00";

                    ExcelStyle cellStyleHeader_TotalDis = worksheet.Cells[2, 23].Style;
                    cellStyleHeader_TotalDis.Border.Left.Style = cellStyleHeader_TotalDis.Border.Right.Style
                            = cellStyleHeader_TotalDis.Border.Top.Style = cellStyleHeader_TotalDis.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
                    ...
                    ExcelStyle cellStyleHeader_TotalNet = worksheet.Cells[2, 24].Style;
                    cellStyleHeader_TotalNet.Border.Left.Style = cellStyleHeader_TotalNet.Border.Right.Style
                            = cellStyleHeader_TotalNet.Border.Top.Style = cellStyleHeader_TotalNet.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    worksheet.Cells[2, 25].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(22) + "" + inStartIndex + ": " + GetExcelColumnLetter(22) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(26) + "" + inStartIndex + ":" + GetExcelColumnLetter(26) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(22) + "" + inStartIndex + ":" + GetExcelColumnLetter(22) + "" + (inwrkrow - 1) + ")))*(-100),2))";
                    worksheet.Cells[2, 25].Style.Numberformat.Format = "#,##0.00";

                    cellStyleHeader_TotalDis = worksheet.Cells[2, 25].Style;
                    cellStyleHeader_TotalDis.Border.Left.Style = cellStyleHeader_TotalDis.Border.Right.Style
                            = cellStyleHeader_TotalDis.Border.Top.Style = cellStyleHeader_TotalDis.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    worksheet.Cells[2, 26].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(26) + "" + inStartIndex + ":" + GetExcelColumnLetter(26) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[2, 26].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[2, 26].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[2, 26].Style.Numberformat.Format = "#,##0";

                    cellStyleHeader_TotalNet = worksheet.Cells[2, 26].Style;
                    cellStyleHeader_TotalNet.Border.Left.Style = cellStyleHeader_TotalNet.Border.Right.Style
                            = cellStyleHeader_TotalNet.Border.Top.Style = cellStyleHeader_TotalNet.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    worksheet.Cells[2, 29].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(22) + "" + inStartIndex + ": " + GetExcelColumnLetter(22) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(30) + "" + inStartIndex + ":" + GetExcelColumnLetter(30) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(22) + "" + inStartIndex + ":" + GetExcelColumnLetter(22) + "" + (inwrkrow - 1) + ")))*(-100),2))";
                    worksheet.Cells[2, 29].Style.Numberformat.Format = "#,##0.00";

                    cellStyleHeader_TotalDis = worksheet.Cells[2, 29].Style;
                    cellStyleHeader_TotalDis.Border.Left.Style = cellStyleHeader_TotalDis.Border.Right.Style
                            = cellStyleHeader_TotalDis.Border.Top.Style = cellStyleHeader_TotalDis.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    worksheet.Cells[2, 30].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(30) + "" + inStartIndex + ":" + GetExcelColumnLetter(30) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[2, 30].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[2, 30].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[2, 30].Style.Numberformat.Format = "#,##0";

                    cellStyleHeader_TotalNet = worksheet.Cells[2, 30].Style;
                    cellStyleHeader_TotalNet.Border.Left.Style = cellStyleHeader_TotalNet.Border.Right.Style
                            = cellStyleHeader_TotalNet.Border.Top.Style = cellStyleHeader_TotalNet.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
        ...
        public static void OrderHistory_Excel(DataTable dtDiamonds, string _strFolderPath, string _strFilePath, string UserTypeList, bool IsPrimaryUser, bool IsSubUser, bool OrderHistoryAll, bool OrderHistoryShowPricing, int SubUserCount)
        {
            try
            {
                if ((IsPrimaryUser == true && (SubUserCount > 0 || UserTypeList.Contains("1") || UserTypeList.Contains("2") || UserTypeList.Contains("4")))
                    ||
                    (IsSubUser == true && OrderHistoryAll == true)
                    )
                {
                    if ((IsPrimaryUser == true)
                       ||
                       (IsSubUser == true && OrderHistoryShowPricing == true)
                       )
                    {
                        using (ExcelPackage p = new ExcelPackage())
                        {
                            ...
                            worksheet.Cells[3, 18].Value = "Final Disc(%)";
                            worksheet.Cells[3, 19].Value = "Final Amt US($)";
                            ...
                            worksheet.Cells[3, 38].Value = "Table Black";
                            worksheet.Cells[3, 39].Value = "Crown Black";
                            worksheet.Cells[3, 40].Value = "Table White";
                            worksheet.Cells[3, 41].Value = "Crown White";
                            ...
                            worksheet.Cells[3, 46].Value = "Girdle Open";
                            ...
                            worksheet.Cells[3, 1].AutoFitColumns(7);                //"Image";
                            worksheet.Cells[3, 2].AutoFitColumns(7);                //"Video";
                            worksheet.Cells[3, 3].AutoFitColumns(12);               //"Order Date";
                            worksheet.Cells[3, 4].AutoFitColumns(9);                //"Order No";
                            worksheet.Cells[3, 5].AutoFitColumns(20);               //"Customer Name";
                            worksheet.Cells[3, 6].AutoFitColumns(27);               //"Company Name";
                            worksheet.Cells[3, 7].AutoFitColumns(12);               //"Ref No";
                            worksheet.Cells[3, 8].AutoFitColumns(18);               //"Status";
                            worksheet.Cells[3, 9].AutoFitColumns(8);                //"Lab";
                            worksheet.Cells[3, 10].AutoFitColumns(10);               //"Shape";
                            worksheet.Cells[3, 11].AutoFitColumns(9);               //"Pointer";
                            worksheet.Cells[3, 12].AutoFitColumns(9);             //"BGM";
                            worksheet.Cells[3, 13].AutoFitColumns(8);               //"Color";
                            worksheet.Cells[3, 14].AutoFitColumns(8);               //"Clarity";
                            worksheet.Cells[3, 15].AutoFitColumns(8);               //"Cts";
                            worksheet.Cells[3, 16].AutoFitColumns(11);              //"Rap Rate($)";
                            worksheet.Cells[3, 17].AutoFitColumns(11);              //"Rap Amount($)";
                            worksheet.Cells[3, 18].AutoFitColumns(10.5);              //"Final Disc(%)";
                            worksheet.Cells[3, 19].AutoFitColumns(11.5);              //"Final Amt US($)";
                            worksheet.Cells[3, 20].AutoFitColumns(11.5);              //"Price / Cts";
                            worksheet.Cells[3, 21].AutoFitColumns(8);               //"Cut";
                            worksheet.Cells[3, 22].AutoFitColumns(8);               //"Polish";
                            worksheet.Cells[3, 23].AutoFitColumns(8);               //"Symm";
                            worksheet.Cells[3, 24].AutoFitColumns(8);               //"Fls";
                            worksheet.Cells[3, 25].AutoFitColumns(8);               //"RATIO";
                            worksheet.Cells[3, 26].AutoFitColumns(25);              //"Key To Symbol";
                            worksheet.Cells[3, 27].AutoFitColumns(8);             //"Length";
                            worksheet.Cells[3, 28].AutoFitColumns(8);             //"Width";
                            worksheet.Cells[3, 29].AutoFitColumns(8);             //"Depth";
                            worksheet.Cells[3, 30].AutoFitColumns(8);             //"Depth (%)";
                            worksheet.Cells[3, 31].AutoFitColumns(8);             //"Table (%)";
                            worksheet.Cells[3, 32].AutoFitColumns(25);              //"Comment";
                            worksheet.Cells[3, 33].AutoFitColumns(8);               //"Girdle(%)";
                            worksheet.Cells[3, 34].AutoFitColumns(8);               //"Crown Angle";
                            worksheet.Cells[3, 35].AutoFitColumns(8);               //"Crown Height";
                            worksheet.Cells[3, 36].AutoFitColumns(8);               //"Pav Angle";
                            worksheet.Cells[3, 37].AutoFitColumns(8);               //"Pav Height";
                            worksheet.Cells[3, 38].AutoFitColumns(8);             //"Table Black";
                            worksheet.Cells[3, 39].AutoFitColumns(8);             //"Crown Black";
                            worksheet.Cells[3, 40].AutoFitColumns(8);             //"Table White";
                            worksheet.Cells[3, 41].AutoFitColumns(8);             //"Crown White";
                            worksheet.Cells[3, 42].AutoFitColumns(8);               //"Culet";
                            worksheet.Cells[3, 43].AutoFitColumns(8);               //"Table Open";
                            worksheet.Cells[3, 44].AutoFitColumns(8);               //"Crown Open";
                            worksheet.Cells[3, 45].AutoFitColumns(8);               //"Pavilion Open";
                            worksheet.Cells[3, 46].AutoFitColumns(8);               //"Girdle Open";
                            ...
                            for (i = inStartIndex; i < inEndCounter; i++)
                            {
                                ...
                                worksheet.Cells[inwrkrow, 8].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Final_Order_Status"]);
                                ...
                                if (URL != "")
                                {
                                    worksheet.Cells[inwrkrow, 9].Formula = "=HYPERLINK(\"" + Convert.ToString(URL) + "\",\" " + Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Lab"]) + " \")";
                            ...
                            worksheet.Cells[inStartIndex, 1, (inwrkrow - 1), 46].Style.Font.Size = 9;
                            //worksheet.Cells[inStartIndex, 17, (inwrkrow - 1), 18].Style.Font.Bold = true;

                            worksheet.Cells[inStartIndex, 15, (inwrkrow - 1), 20].Style.Numberformat.Format = "0.00";
                            worksheet.Cells[inStartIndex, 25, (inwrkrow - 1), 25].Style.Numberformat.Format = "0.00";
                            worksheet.Cells[inStartIndex, 15, (inwrkrow - 1), 20].Style.Numberformat.Format = "#,##0.00";

                            worksheet.Cells[inStartIndex, 27, (inwrkrow - 1), 30].Style.Numberformat.Format = "0.00";
                            worksheet.Cells[inStartIndex, 33, (inwrkrow - 1), 37].Style.Numberformat.Format = "0.00";
                            ...
                            worksheet.Cells[inStartIndex, 20, (inwrkrow - 1), 20].Style.Fill.PatternType = ExcelFillStyle.Solid;
                            worksheet.Cells[inStartIndex, 20, (inwrkrow - 1), 20].Style.Fill.BackgroundColor.SetColor(ppc_bg);

                            worksheet.Cells[inStartIndex, 25, (inwrkrow - 1), 25].Style.Fill.PatternType = ExcelFillStyle.Solid;
                            worksheet.Cells[inStartIndex, 25, (inwrkrow - 1), 25].Style.Fill.BackgroundColor.SetColor(ratio_bg);
                            ...
                            ExcelStyle cellStyleHeader_TotalRapAmt = worksheet.Cells[2, 17].Style;
                            cellStyleHeader_TotalRapAmt.Border.Left.Style = cellStyleHeader_TotalRapAmt.Border.Right.Style
                                    = cellStyleHeader_TotalRapAmt.Border.Top.Style = cellStyleHeader_TotalRapAmt.Border.Bottom.Style
                                    = ExcelBorderStyle.Medium;
                    ...
                    else
                    {
                        using (ExcelPackage p = new ExcelPackage())
                        {
                            ...
                            worksheet.Cells[2, 1].Value = "Total";
                            worksheet.Cells[2, 1, 2, 43].Style.Font.Bold = true;
                            worksheet.Cells[2, 1, 2, 43].Style.Font.Size = 11;
                            worksheet.Cells[2, 1, 2, 43].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                            worksheet.Cells[2, 1, 2, 43].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                            worksheet.Cells[2, 1, 2, 43].Style.Font.Size = 11;

                            worksheet.Cells[3, 1, 3, 43].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                            worksheet.Cells[3, 1, 3, 43].Style.VerticalAlignment = ExcelVerticalAlignment.Top;
                            worksheet.Cells[3, 1, 3, 43].Style.Font.Size = 10;
                            worksheet.Cells[3, 1, 3, 43].Style.Font.Bold = true;

                            worksheet.Cells[3, 1, 3, 43].AutoFilter = true;

                            var cellBackgroundColor1 = worksheet.Cells[3, 1, 3, 43].Style.Fill;
                            cellBackgroundColor1.PatternType = ExcelFillStyle.Solid;
                            Color colFromHex = System.Drawing.ColorTranslator.FromHtml("#d3d3d3");
                            cellBackgroundColor1.BackgroundColor.SetColor(colFromHex);
                            ...
                            worksheet.Cells[3, 21].Value = "Fls";
                            worksheet.Cells[3, 22].Value = "RATIO";
                            worksheet.Cells[3, 23].Value = "Key To Symbol";
                            worksheet.Cells[3, 24].Value = "Length";
                            worksheet.Cells[3, 25].Value = "Width";
                            worksheet.Cells[3, 26].Value = "Depth";
                            worksheet.Cells[3, 27].Value = "Depth (%)";
                            worksheet.Cells[3, 28].Value = "Table (%)";
                            worksheet.Cells[3, 29].Value = "Comment";
                            worksheet.Cells[3, 30].Value = "Girdle(%)";
                            worksheet.Cells[3, 31].Value = "Crown Angle";
                            worksheet.Cells[3, 32].Value = "Crown Height";
                            worksheet.Cells[3, 33].Value = "Pav Angle";
                            worksheet.Cells[3, 34].Value = "Pav Height";
                            worksheet.Cells[3, 35].Value = "Table Black";
                            worksheet.Cells[3, 36].Value = "Crown Black";
                            worksheet.Cells[3, 37].Value = "Table White";
                            worksheet.Cells[3, 38].Value = "Crown White";
                            ...
                            worksheet.Cells[3, 16].AutoFitColumns(11);              // "Rap Rate($)";
                            worksheet.Cells[3, 17].AutoFitColumns(11);              // "Rap Amount($)";
                            worksheet.Cells[3, 18].AutoFitColumns(8);               // "Cut";
                            worksheet.Cells[3, 19].AutoFitColumns(8);               // "Polish";
                            worksheet.Cells[3, 20].AutoFitColumns(8);               // "Symm";
                            worksheet.Cells[3, 21].AutoFitColumns(8);               // "Fls";
                            worksheet.Cells[3, 22].AutoFitColumns(8);               // "RATIO";
                            worksheet.Cells[3, 23].AutoFitColumns(25);              // "Key To Symbol";
                            worksheet.Cells[3, 24].AutoFitColumns(8);               // "Length";
                            worksheet.Cells[3, 25].AutoFitColumns(8);               // "Width";
                            worksheet.Cells[3, 26].AutoFitColumns(8);               // "Depth";
                            worksheet.Cells[3, 27].AutoFitColumns(8);               // "Depth (%)";
                            worksheet.Cells[3, 28].AutoFitColumns(8);               // "Table (%)";
                            worksheet.Cells[3, 29].AutoFitColumns(25);              // "Comment";
                            worksheet.Cells[3, 30].AutoFitColumns(8);               // "Girdle(%)";
                            worksheet.Cells[3, 31].AutoFitColumns(8);               // "Crown Angle";
                            worksheet.Cells[3, 32].AutoFitColumns(8);               // "Crown Height";
                            worksheet.Cells[3, 33].AutoFitColumns(8);               // "Pav Angle";
                            worksheet.Cells[3, 34].AutoFitColumns(8);               // "Pav Height";
                            worksheet.Cells[3, 35].AutoFitColumns(8);               // "Table Black";
                            worksheet.Cells[3, 36].AutoFitColumns(8);               // "Crown Black";
                            worksheet.Cells[3, 37].AutoFitColumns(8);               // "Table White";
                            worksheet.Cells[3, 38].AutoFitColumns(8);               // "Crown White";
                            worksheet.Cells[3, 39].AutoFitColumns(8);               // "Culet";
                            worksheet.Cells[3, 40].AutoFitColumns(8);               // "Table Open";
                            worksheet.Cells[3, 41].AutoFitColumns(8);               // "Crown Open";
                            worksheet.Cells[3, 42].AutoFitColumns(8);               // "Pavilion Open";
                            worksheet.Cells[3, 43].AutoFitColumns(8);               // "Girdle Open";


                            //Set Cell Faoat value with Alignment
                            worksheet.Cells[inStartIndex, 1, inEndCounter, 43].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                            ...
                            for (i = inStartIndex; i < inEndCounter; i++)
                            {
                                ...
                                worksheet.Cells[inwrkrow, 22].Value = ((dtDiamonds.Rows[i - inStartIndex]["RATIO"] != null) ?
                                           (dtDiamonds.Rows[i - inStartIndex]["RATIO"].GetType().Name != "DBNull" ?
                                           Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["RATIO"]) : ((Double?)null)) : null);

                                worksheet.Cells[inwrkrow, 23].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Key_To_Symboll"]);
                                worksheet.Cells[inwrkrow, 24].Value = ((dtDiamonds.Rows[i - inStartIndex]["Length"] != null) ?
                                           (dtDiamonds.Rows[i - inStartIndex]["Length"].GetType().Name != "DBNull" ?
                                           Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Length"]) : ((Double?)null)) : null);

                                worksheet.Cells[inwrkrow, 25].Value = ((dtDiamonds.Rows[i - inStartIndex]["Width"] != null) ?
                                           (dtDiamonds.Rows[i - inStartIndex]["Width"].GetType().Name != "DBNull" ?
                                           Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Width"]) : ((Double?)null)) : null);

                                worksheet.Cells[inwrkrow, 26].Value = ((dtDiamonds.Rows[i - inStartIndex]["Depth"] != null) ?
                                           (dtDiamonds.Rows[i - inStartIndex]["Depth"].GetType().Name != "DBNull" ?
                                           Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Depth"]) : ((Double?)null)) : null);

                                worksheet.Cells[inwrkrow, 27].Value = ((dtDiamonds.Rows[i - inStartIndex]["Depth_Per"] != null) ?
                                           (dtDiamonds.Rows[i - inStartIndex]["Depth_Per"].GetType().Name != "DBNull" ?
                                           Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Depth_Per"]) : ((Double?)null)) : null);
                                ...
                                worksheet.Cells[inwrkrow, 31].Value = ((dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"] != null) ?
                                           (dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"].GetType().Name != "DBNull" ?
                                           Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"]) : ((Double?)null)) : null);

                                worksheet.Cells[inwrkrow, 32].Value = ((dtDiamonds.Rows[i - inStartIndex]["Crown_Height"] != null) ?
                                           (dtDiamonds.Rows[i - inStartIndex]["Crown_Height"].GetType().Name != "DBNull" ?
                                           Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Crown_Height"]) : ((Double?)null)) : null);

                                worksheet.Cells[inwrkrow, 33].Value = ((dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"] != null) ?
                                           (dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"].GetType().Name != "DBNull" ?
                                           Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"]) : ((Double?)null)) : null);

                                worksheet.Cells[inwrkrow, 34].Value = ((dtDiamonds.Rows[i - inStartIndex]["Pav_Height"] != null) ?
                                           (dtDiamonds.Rows[i - inStartIndex]["Pav_Height"].GetType().Name != "DBNull" ?
                                           Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Pav_Height"]) : ((Double?)null)) : null);

                                worksheet.Cells[inwrkrow, 35].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Table_Natts"]);
                                worksheet.Cells[inwrkrow, 36].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Crown_Natts"]);
                                worksheet.Cells[inwrkrow, 37].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Table_Inclusion"]);
                            ...
                            worksheet.Cells[inStartIndex, 1, (inwrkrow - 1), 43].Style.Font.Size = 9;

                            worksheet.Cells[inStartIndex, 15, (inwrkrow - 1), 17].Style.Numberformat.Format = "0.00";
                            ...
                            worksheet.Cells[inStartIndex, 22, (inwrkrow - 1), 22].Style.Fill.PatternType = ExcelFillStyle.Solid;
                            worksheet.Cells[inStartIndex, 22, (inwrkrow - 1), 22].Style.Fill.BackgroundColor.SetColor(ratio_bg);
                ...
                else
                {
                       ...
                       )
                    {
                        using (ExcelPackage p = new ExcelPackage())
                        {
                            ...
                            worksheet.Cells[3, 16].Value = "Final Disc(%)";
                            worksheet.Cells[3, 17].Value = "Final Amt US($)";
                            ...
                            worksheet.Cells[3, 36].Value = "Table Black";
                            worksheet.Cells[3, 37].Value = "Crown Black";
                            worksheet.Cells[3, 38].Value = "Table White";
                            worksheet.Cells[3, 39].Value = "Crown White";
                            ...
                            worksheet.Cells[3, 3].AutoFitColumns(12);           //"Order Date";
                            worksheet.Cells[3, 4].AutoFitColumns(9);            //"Order No";
                            worksheet.Cells[3, 5].AutoFitColumns(12);           //"Ref No";
                            worksheet.Cells[3, 6].AutoFitColumns(18);           //"Status";
                            worksheet.Cells[3, 7].AutoFitColumns(8);            //"Lab";
                            worksheet.Cells[3, 8].AutoFitColumns(10);           //"Shape";
                            worksheet.Cells[3, 9].AutoFitColumns(9);            //"Pointer";
                            worksheet.Cells[3, 10].AutoFitColumns(9);          //"BGM";
                            worksheet.Cells[3, 11].AutoFitColumns(8);           //"Color";
                            worksheet.Cells[3, 12].AutoFitColumns(8);           //"Clarity";
                            worksheet.Cells[3, 13].AutoFitColumns(8);           //"Cts";
                            worksheet.Cells[3, 14].AutoFitColumns(11);          //"Rap Rate($)";
                            worksheet.Cells[3, 15].AutoFitColumns(11);          //"Rap Amount($)";
                            worksheet.Cells[3, 16].AutoFitColumns(10.5);          //"Final Disc(%)";
                            worksheet.Cells[3, 17].AutoFitColumns(11.5);          //"Final Amt US($)";
                            worksheet.Cells[3, 18].AutoFitColumns(11.5);          //"Price / Cts";
                            worksheet.Cells[3, 19].AutoFitColumns(8);           //"Cut";
                            worksheet.Cells[3, 20].AutoFitColumns(8);           //"Polish";
                            worksheet.Cells[3, 21].AutoFitColumns(8);           //"Symm";
                            worksheet.Cells[3, 22].AutoFitColumns(8);           //"Fls";
                            worksheet.Cells[3, 23].AutoFitColumns(8);           //"RATIO";
                            worksheet.Cells[3, 24].AutoFitColumns(25);          //"Key To Symbol";
                            worksheet.Cells[3, 25].AutoFitColumns(8);         //"Length";
                            worksheet.Cells[3, 26].AutoFitColumns(8);         //"Width";
                            worksheet.Cells[3, 27].AutoFitColumns(8);         //"Depth";
                            worksheet.Cells[3, 28].AutoFitColumns(8);         //"Depth (%)";
                            worksheet.Cells[3, 29].AutoFitColumns(8);         //"Table (%)";
                            worksheet.Cells[3, 30].AutoFitColumns(25);          //"Comment";
                            worksheet.Cells[3, 31].AutoFitColumns(8);           //"Girdle(%)";
                            worksheet.Cells[3, 32].AutoFitColumns(8);           //"Crown Angle";
                            worksheet.Cells[3, 33].AutoFitColumns(8);           //"Crown Height";
                            worksheet.Cells[3, 34].AutoFitColumns(8);           //"Pav Angle";
                            worksheet.Cells[3, 35].AutoFitColumns(8);           //"Pav Height";
                            worksheet.Cells[3, 36].AutoFitColumns(8);         //"Table Black";
                            worksheet.Cells[3, 37].AutoFitColumns(8);         //"Crown Black";
                            worksheet.Cells[3, 38].AutoFitColumns(8);         //"Table White";
                            worksheet.Cells[3, 39].AutoFitColumns(8);         //"Crown White";
                            worksheet.Cells[3, 40].AutoFitColumns(8);           //"Culet";
                            worksheet.Cells[3, 41].AutoFitColumns(8);           //"Table Open";
                            worksheet.Cells[3, 42].AutoFitColumns(8);           //"Crown Open";
                            worksheet.Cells[3, 43].AutoFitColumns(8);           //"Pavilion Open";
                            worksheet.Cells[3, 44].AutoFitColumns(8);           //"Girdle Open";
                            ...
                            for (i = inStartIndex; i < inEndCounter; i++)
                            {
                                ...
                                worksheet.Cells[inwrkrow, 6].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Final_Order_Status"]);
                                ...
                                if (URL != "")
                                {
                                    worksheet.Cells[inwrkrow, 7].Formula = "=HYPERLINK(\"" + Convert.ToString(URL) + "\",\" " + Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Lab"]) + " \")";
                            ...
                            //worksheet.Cells[inStartIndex, 15, (inwrkrow - 1), 16].Style.Font.Bold = true;
                            ...
                            worksheet.Cells[inStartIndex, 16, (inwrkrow - 1), 17].Style.Fill.PatternType = ExcelFillStyle.Solid;
                            worksheet.Cells[inStartIndex, 16, (inwrkrow - 1), 17].Style.Fill.BackgroundColor.SetColor(cellBg);

                            worksheet.Cells[inStartIndex, 18, (inwrkrow - 1), 18].Style.Fill.PatternType = ExcelFillStyle.Solid;
                            worksheet.Cells[inStartIndex, 18, (inwrkrow - 1), 18].Style.Fill.BackgroundColor.SetColor(ppc_bg);

                            worksheet.Cells[inStartIndex, 23, (inwrkrow - 1), 23].Style.Fill.PatternType = ExcelFillStyle.Solid;
                            worksheet.Cells[inStartIndex, 23, (inwrkrow - 1), 23].Style.Fill.BackgroundColor.SetColor(ratio_bg);
                            ...
                            worksheet.Cells[2, 15].Style.Fill.PatternType = ExcelFillStyle.Solid;
                            worksheet.Cells[2, 15].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                            worksheet.Cells[2, 15].Style.Numberformat.Format = "#,##0";

                            ExcelStyle cellStyleHeader_TotalRapAmt = worksheet.Cells[2, 15].Style;
                            cellStyleHeader_TotalRapAmt.Border.Left.Style = cellStyleHeader_TotalRapAmt.Border.Right.Style
                                    = cellStyleHeader_TotalRapAmt.Border.Top.Style = cellStyleHeader_TotalRapAmt.Border.Bottom.Style
                                    = ExcelBorderStyle.Medium;
                    ...
                    else
                    {
                        using (ExcelPackage p = new ExcelPackage())
                        {
                            ...
                            worksheet.Cells[2, 1].Value = "Total";
                            worksheet.Cells[2, 1, 2, 41].Style.Font.Bold = true;
                            worksheet.Cells[2, 1, 2, 41].Style.Font.Size = 11;
                            worksheet.Cells[2, 1, 2, 41].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                            worksheet.Cells[2, 1, 2, 41].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                            worksheet.Cells[2, 1, 2, 41].Style.Font.Size = 11;

                            worksheet.Cells[3, 1, 3, 41].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                            worksheet.Cells[3, 1, 3, 41].Style.VerticalAlignment = ExcelVerticalAlignment.Top;
                            worksheet.Cells[3, 1, 3, 41].Style.Font.Size = 10;
                            worksheet.Cells[3, 1, 3, 41].Style.Font.Bold = true;

                            worksheet.Cells[3, 1, 3, 41].AutoFilter = true;

                            var cellBackgroundColor1 = worksheet.Cells[3, 1, 3, 41].Style.Fill;
                            cellBackgroundColor1.PatternType = ExcelFillStyle.Solid;
                            Color colFromHex = System.Drawing.ColorTranslator.FromHtml("#d3d3d3");
                            cellBackgroundColor1.BackgroundColor.SetColor(colFromHex);
                            ...
                            worksheet.Cells[3, 14].Value = "Rap Rate($)";
                            worksheet.Cells[3, 15].Value = "Rap Amount($)";
                            worksheet.Cells[3, 16].Value = "Cut";
                            worksheet.Cells[3, 17].Value = "Polish";
                            worksheet.Cells[3, 18].Value = "Symm";
                            worksheet.Cells[3, 19].Value = "Fls";
                            worksheet.Cells[3, 20].Value = "RATIO";
                            worksheet.Cells[3, 21].Value = "Key To Symbol";
                            ...
                            worksheet.Cells[3, 27].Value = "Comment";
                            worksheet.Cells[3, 28].Value = "Girdle(%)";
                            worksheet.Cells[3, 29].Value = "Crown Angle";
                            worksheet.Cells[3, 30].Value = "Crown Height";
                            worksheet.Cells[3, 31].Value = "Pav Angle";
                            worksheet.Cells[3, 32].Value = "Pav Height";
                            worksheet.Cells[3, 33].Value = "Table Black";
                            worksheet.Cells[3, 34].Value = "Crown Black";
                            worksheet.Cells[3, 35].Value = "Table White";
                            worksheet.Cells[3, 36].Value = "Crown White";
                            worksheet.Cells[3, 37].Value = "Culet";
                            worksheet.Cells[3, 38].Value = "Table Open";
                            worksheet.Cells[3, 39].Value = "Crown Open";
                            worksheet.Cells[3, 40].Value = "Pavilion Open";
                            worksheet.Cells[3, 41].Value = "Girdle Open";


                            ExcelStyle cellStyleHeader1 = worksheet.Cells[3, 1, 3, 41].Style;
                            cellStyleHeader1.Border.Left.Style = cellStyleHeader1.Border.Right.Style
                                    = cellStyleHeader1.Border.Top.Style = cellStyleHeader1.Border.Bottom.Style
                                    = ExcelBorderStyle.Medium;
                            ...
                            worksheet.Cells[3, 14].AutoFitColumns(11);          // "Rap Rate($)";
                            worksheet.Cells[3, 15].AutoFitColumns(11);          // "Rap Amount($)";
                            worksheet.Cells[3, 16].AutoFitColumns(8);           // "Cut";
                            worksheet.Cells[3, 17].AutoFitColumns(8);           // "Polish";
                            worksheet.Cells[3, 18].AutoFitColumns(8);           // "Symm";
                            worksheet.Cells[3, 19].AutoFitColumns(8);           // "Fls";
                            worksheet.Cells[3, 20].AutoFitColumns(8);           // "RATIO";
                            worksheet.Cells[3, 21].AutoFitColumns(25);          // "Key To Symbol";
                            worksheet.Cells[3, 22].AutoFitColumns(8);           // "Length";
                            worksheet.Cells[3, 23].AutoFitColumns(8);           // "Width";
                            worksheet.Cells[3, 24].AutoFitColumns(8);           // "Depth";
                            worksheet.Cells[3, 25].AutoFitColumns(8);           // "Depth (%)";
                            worksheet.Cells[3, 26].AutoFitColumns(8);           // "Table (%)";
                            worksheet.Cells[3, 27].AutoFitColumns(25);          // "Comment";
                            worksheet.Cells[3, 28].AutoFitColumns(8);           // "Girdle(%)";
                            worksheet.Cells[3, 29].AutoFitColumns(8);           // "Crown Angle";
                            worksheet.Cells[3, 30].AutoFitColumns(8);           // "Crown Height";
                            worksheet.Cells[3, 31].AutoFitColumns(8);           // "Pav Angle";
                            worksheet.Cells[3, 32].AutoFitColumns(8);           // "Pav Height";
                            worksheet.Cells[3, 33].AutoFitColumns(8);           // "Table Black";
                            worksheet.Cells[3, 34].AutoFitColumns(8);           // "Crown Black";
                            worksheet.Cells[3, 35].AutoFitColumns(8);           // "Table White";
                            worksheet.Cells[3, 36].AutoFitColumns(8);           // "Crown White";
                            worksheet.Cells[3, 37].AutoFitColumns(8);           // "Culet";
                            worksheet.Cells[3, 38].AutoFitColumns(8);           // "Table Open";
                            worksheet.Cells[3, 39].AutoFitColumns(8);           // "Crown Open";
                            worksheet.Cells[3, 40].AutoFitColumns(8);           // "Pavilion Open";
                            worksheet.Cells[3, 41].AutoFitColumns(8);           // "Girdle Open";
                            ...
                            for (i = inStartIndex; i < inEndCounter; i++)
                            {
                                ...
                                worksheet.Cells[inwrkrow, 21].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Key_To_Symboll"]);
                            ...
                            worksheet.Cells[inStartIndex, 13, (inwrkrow - 1), 15].Style.Numberformat.Format = "0.00";
                            worksheet.Cells[inStartIndex, 20, (inwrkrow - 1), 20].Style.Numberformat.Format = "0.00";
                            worksheet.Cells[inStartIndex, 14, (inwrkrow - 1), 15].Style.Numberformat.Format = "#,##0.00";

                            worksheet.Cells[inStartIndex, 22, (inwrkrow - 1), 25].Style.Numberformat.Format = "0.00";
                            worksheet.Cells[inStartIndex, 28, (inwrkrow - 1), 32].Style.Numberformat.Format = "0.00";
        ...
        public static void PlaceOrder_Excel(DataTable dtDiamonds, string _strFolderPath, string _strFilePath, int Orderid)
        {
            try
            {
                using (ExcelPackage p = new ExcelPackage())
                {
                    ...
                    Color cellStatus = System.Drawing.ColorTranslator.FromHtml("#FFF2CC");
                    Color cellBg = System.Drawing.ColorTranslator.FromHtml("#ccffff");
                    Color ppc_bg = System.Drawing.ColorTranslator.FromHtml("#c6e0b4");
                    Color ratio_bg = System.Drawing.ColorTranslator.FromHtml("#bdd7ee");
                    ...
                    p.Workbook.Worksheets.Add("Order No : " + Orderid);
                    ...
                    worksheet.Cells[2, 1].Value = "Total";
                    worksheet.Cells[2, 1, 2, 42].Style.Font.Bold = true;
                    worksheet.Cells[2, 1, 2, 42].Style.Font.Size = 11;
                    worksheet.Cells[2, 1, 2, 42].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    worksheet.Cells[2, 1, 2, 42].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                    worksheet.Cells[2, 1, 2, 42].Style.Font.Size = 11;

                    worksheet.Cells[3, 1, 3, 42].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    worksheet.Cells[3, 1, 3, 42].Style.VerticalAlignment = ExcelVerticalAlignment.Top;
                    worksheet.Cells[3, 1, 3, 42].Style.Font.Size = 10;
                    worksheet.Cells[3, 1, 3, 42].Style.Font.Bold = true;

                    worksheet.Cells[3, 1, 3, 42].AutoFilter = true;

                    var cellBackgroundColor1 = worksheet.Cells[3, 1, 3, 42].Style.Fill;
                    cellBackgroundColor1.PatternType = ExcelFillStyle.Solid;
                    Color colFromHex = System.Drawing.ColorTranslator.FromHtml("#d3d3d3");
                    cellBackgroundColor1.BackgroundColor.SetColor(colFromHex);
                    ...
                    worksheet.Cells[3, 3].Value = "Image";
                    worksheet.Cells[3, 4].Value = "Video";
                    worksheet.Cells[3, 5].Value = "Shape";
                    worksheet.Cells[3, 6].Value = "Status";
                    worksheet.Cells[3, 7].Value = "Pointer";
                    worksheet.Cells[3, 8].Value = "BGM";
                    worksheet.Cells[3, 9].Value = "Color";
                    worksheet.Cells[3, 10].Value = "Clarity";
                    worksheet.Cells[3, 11].Value = "Cts";
                    worksheet.Cells[3, 12].Value = "Rap Rate($)";
                    worksheet.Cells[3, 13].Value = "Rap Amount($)";
                    worksheet.Cells[3, 14].Value = "Final Disc(%)";
                    worksheet.Cells[3, 15].Value = "Final Amt US($)";
                    ...
                    worksheet.Cells[3, 20].Value = "Fls";
                    worksheet.Cells[3, 21].Value = "RATIO";
                    worksheet.Cells[3, 22].Value = "Length";
                    worksheet.Cells[3, 23].Value = "Width";
                    worksheet.Cells[3, 24].Value = "Depth";
                    worksheet.Cells[3, 25].Value = "Depth (%)";
                    ...
                    worksheet.Cells[3, 28].Value = "Comment";
                    worksheet.Cells[3, 29].Value = "Girdle(%)";
                    worksheet.Cells[3, 30].Value = "Crown Angle";
                    worksheet.Cells[3, 31].Value = "Crown Height";
                    worksheet.Cells[3, 32].Value = "Pav Angle";
                    worksheet.Cells[3, 33].Value = "Pav Height";
                    worksheet.Cells[3, 34].Value = "Table Black";
                    worksheet.Cells[3, 35].Value = "Crown Black";
                    worksheet.Cells[3, 36].Value = "Table White";
                    worksheet.Cells[3, 37].Value = "Crown White";
                    ...
                    worksheet.Cells[3, 1].AutoFitColumns(12);
                    worksheet.Cells[3, 2].AutoFitColumns(8);
                    worksheet.Cells[3, 3].AutoFitColumns(7);
                    worksheet.Cells[3, 4].AutoFitColumns(7);
                    worksheet.Cells[3, 5].AutoFitColumns(10);
                    worksheet.Cells[3, 6].AutoFitColumns(18);
                    worksheet.Cells[3, 7].AutoFitColumns(9);
                    worksheet.Cells[3, 8].AutoFitColumns(9);
                    worksheet.Cells[3, 9].AutoFitColumns(8);
                    worksheet.Cells[3, 10].AutoFitColumns(8);
                    worksheet.Cells[3, 11].AutoFitColumns(8);
                    worksheet.Cells[3, 12].AutoFitColumns(11);
                    worksheet.Cells[3, 13].AutoFitColumns(11);
                    worksheet.Cells[3, 14].AutoFitColumns(10.5);
                    worksheet.Cells[3, 15].AutoFitColumns(11.5);
                    worksheet.Cells[3, 16].AutoFitColumns(11.5);
                    worksheet.Cells[3, 17].AutoFitColumns(8);
                    worksheet.Cells[3, 18].AutoFitColumns(8);
                    worksheet.Cells[3, 19].AutoFitColumns(8);
                    worksheet.Cells[3, 20].AutoFitColumns(8);
                    worksheet.Cells[3, 21].AutoFitColumns(8);
                    worksheet.Cells[3, 22].AutoFitColumns(8);
                    worksheet.Cells[3, 23].AutoFitColumns(8);
                    worksheet.Cells[3, 24].AutoFitColumns(8);
                    worksheet.Cells[3, 25].AutoFitColumns(8);
                    worksheet.Cells[3, 26].AutoFitColumns(8);
                    worksheet.Cells[3, 27].AutoFitColumns(25);
                    worksheet.Cells[3, 28].AutoFitColumns(25);
                    worksheet.Cells[3, 29].AutoFitColumns(8);
                    worksheet.Cells[3, 30].AutoFitColumns(8);
                    worksheet.Cells[3, 31].AutoFitColumns(8);
                    worksheet.Cells[3, 32].AutoFitColumns(8);
                    worksheet.Cells[3, 33].AutoFitColumns(8);
                    worksheet.Cells[3, 34].AutoFitColumns(8);
                    ...
                    worksheet.Cells[3, 38].AutoFitColumns(8);
                    worksheet.Cells[3, 39].AutoFitColumns(8);
                    worksheet.Cells[3, 40].AutoFitColumns(8);
                    worksheet.Cells[3, 41].AutoFitColumns(8);
                    worksheet.Cells[3, 42].AutoFitColumns(8);
                    ...
                    for (i = inStartIndex; i < inEndCounter; i++)
                    {
                        ...
                        worksheet.Cells[inwrkrow, 5].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Shape"]);
                        worksheet.Cells[inwrkrow, 6].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Order_Status"]);
                        worksheet.Cells[inwrkrow, 7].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Pointer"]);
                        worksheet.Cells[inwrkrow, 8].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["BGM"]);
                        worksheet.Cells[inwrkrow, 9].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Color"]);
                        worksheet.Cells[inwrkrow, 10].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Clarity"]);
                        worksheet.Cells[inwrkrow, 11].Value = ((dtDiamonds.Rows[i - inStartIndex]["Cts"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["Cts"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Cts"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 12].Value = ((dtDiamonds.Rows[i - inStartIndex]["Rap_Rate"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["Rap_Rate"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Rap_Rate"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 13].Value = ((dtDiamonds.Rows[i - inStartIndex]["Rap_Amount"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["Rap_Amount"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Rap_Amount"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 14].Value = ((dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_DISC"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_DISC"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_DISC"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 15].Value = ((dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_VALUE"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_VALUE"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["CUSTOMER_COST_VALUE"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 16].Value = ((dtDiamonds.Rows[i - inStartIndex]["Base_Price_Cts"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["Base_Price_Cts"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Base_Price_Cts"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 17].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Cut"]);
                        worksheet.Cells[inwrkrow, 18].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Polish"]);
                        worksheet.Cells[inwrkrow, 19].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Symm"]);
                        worksheet.Cells[inwrkrow, 20].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Fls"]);
                        worksheet.Cells[inwrkrow, 21].Value = ((dtDiamonds.Rows[i - inStartIndex]["RATIO"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["RATIO"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["RATIO"]) : ((Double?)null)) : null);
                        ...
                        worksheet.Cells[inwrkrow, 30].Value = ((dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Crown_Angle"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 31].Value = ((dtDiamonds.Rows[i - inStartIndex]["Crown_Height"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["Crown_Height"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Crown_Height"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 32].Value = ((dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Pav_Angle"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 33].Value = ((dtDiamonds.Rows[i - inStartIndex]["Pav_Height"] != null) ?
                                   (dtDiamonds.Rows[i - inStartIndex]["Pav_Height"].GetType().Name != "DBNull" ?
                                   Convert.ToDouble(dtDiamonds.Rows[i - inStartIndex]["Pav_Height"]) : ((Double?)null)) : null);

                        worksheet.Cells[inwrkrow, 34].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Table_Natts"]);
                        worksheet.Cells[inwrkrow, 35].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Crown_Natts"]);
                        worksheet.Cells[inwrkrow, 36].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Table_Inclusion"]);
                    ...
                    worksheet.Cells[inStartIndex, 1, (inwrkrow - 1), 42].Style.Font.Size = 9;

                    worksheet.Cells[inStartIndex, 11, (inwrkrow - 1), 16].Style.Numberformat.Format = "0.00";
                    worksheet.Cells[inStartIndex, 21, (inwrkrow - 1), 21].Style.Numberformat.Format = "0.00";
                    worksheet.Cells[inStartIndex, 12, (inwrkrow - 1), 16].Style.Numberformat.Format = "#,##0.00";

                    worksheet.Cells[inStartIndex, 22, (inwrkrow - 1), 25].Style.Numberformat.Format = "0.00";
                    worksheet.Cells[inStartIndex, 29, (inwrkrow - 1), 33].Style.Numberformat.Format = "0.00";

                    worksheet.Cells[inStartIndex, 6, (inwrkrow - 1), 6].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[inStartIndex, 6, (inwrkrow - 1), 6].Style.Fill.BackgroundColor.SetColor(cellStatus);
                    worksheet.Cells[inStartIndex, 6, (inwrkrow - 1), 6].Style.Font.Color.SetColor(System.Drawing.Color.Red);

                    worksheet.Cells[inStartIndex, 14, (inwrkrow - 1), 15].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[inStartIndex, 14, (inwrkrow - 1), 15].Style.Fill.BackgroundColor.SetColor(cellBg);

                    worksheet.Cells[inStartIndex, 16, (inwrkrow - 1), 16].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[inStartIndex, 16, (inwrkrow - 1), 16].Style.Fill.BackgroundColor.SetColor(ppc_bg);

                    worksheet.Cells[inStartIndex, 21, (inwrkrow - 1), 21].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[inStartIndex, 21, (inwrkrow - 1), 21].Style.Fill.BackgroundColor.SetColor(ratio_bg);




                    worksheet.Cells[2, 1].Formula = "ROUND(SUBTOTAL(102," + GetExcelColumnLetter(11) + "" + inStartIndex + ":" + GetExcelColumnLetter(11) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[2, 1].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[2, 1].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[2, 1].Style.Numberformat.Format = "#,##";

                    ExcelStyle cellStyleHeader_Total = worksheet.Cells[2, 1].Style;
                    cellStyleHeader_Total.Border.Left.Style = cellStyleHeader_Total.Border.Right.Style
                            = cellStyleHeader_Total.Border.Top.Style = cellStyleHeader_Total.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    worksheet.Cells[2, 11].Formula = "ROUND(SUBTOTAL(109," + GetExcelColumnLetter(11) + "" + inStartIndex + ":" + GetExcelColumnLetter(11) + "" + (inwrkrow - 1) + "),2)";
                    worksheet.Cells[2, 11].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[2, 11].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[2, 11].Style.Numberformat.Format = "#,##0.00";

                    ExcelStyle cellStyleHeader_Totalcarat = worksheet.Cells[2, 11].Style;
                    cellStyleHeader_Totalcarat.Border.Left.Style = cellStyleHeader_Totalcarat.Border.Right.Style
                            = cellStyleHeader_Totalcarat.Border.Top.Style = cellStyleHeader_Totalcarat.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
                    ...
                    worksheet.Cells[2, 13].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    worksheet.Cells[2, 13].Style.Fill.BackgroundColor.SetColor(colFromHexTotal);
                    worksheet.Cells[2, 13].Style.Numberformat.Format = "#,##0";

                    ExcelStyle cellStyleHeader_RapAmt = worksheet.Cells[2, 13].Style;
                    cellStyleHeader_RapAmt.Border.Left.Style = cellStyleHeader_RapAmt.Border.Right.Style
                            = cellStyleHeader_RapAmt.Border.Top.Style = cellStyleHeader_RapAmt.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;

                    worksheet.Cells[2, 14].Formula = "IF(SUBTOTAL(109," + GetExcelColumnLetter(13) + "" + inStartIndex + ": " + GetExcelColumnLetter(13) + "" + (inwrkrow - 1) + ")=0,0,ROUND((1-(SUBTOTAL(109," + GetExcelColumnLetter(15) + "" + inStartIndex + ":" + GetExcelColumnLetter(15) + "" + (inwrkrow - 1) + ")/SUBTOTAL(109," + GetExcelColumnLetter(13) + "" + inStartIndex + ":" + GetExcelColumnLetter(13) + "" + (inwrkrow - 1) + ")))*(-100),2))";
                    worksheet.Cells[2, 14].Style.Numberformat.Format = "#,##0.00";

                    ExcelStyle cellStyleHeader_TotalDis = worksheet.Cells[2, 14].Style;
                    cellStyleHeader_TotalDis.Border.Left.Style = cellStyleHeader_TotalDis.Border.Right.Style
                            = cellStyleHeader_TotalDis.Border.Top.Style = cellStyleHeader_TotalDis.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
                    ...
                    ExcelStyle cellStyleHeader_TotalNet = worksheet.Cells[2, 15].Style;
                    cellStyleHeader_TotalNet.Border.Left.Style = cellStyleHeader_TotalNet.Border.Right.Style
                            = cellStyleHeader_TotalNet.Border.Top.Style = cellStyleHeader_TotalNet.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
        ...
        public static void MyCart_Excel(DataTable dtDiamonds, string _strFolderPath, string _strFilePath, string UserTypeList, bool IsPrimaryUser, int SubUserCount)
        {
            try
            {
                if (IsPrimaryUser == true && (SubUserCount > 0 || UserTypeList.Contains("1") || UserTypeList.Contains("2") || UserTypeList.Contains("4")))
                {
                    using (ExcelPackage p = new ExcelPackage())
                    {
                        ...
                        worksheet.Cells[3, 1].AutoFitColumns(7);                    //"Image";
                        worksheet.Cells[3, 2].AutoFitColumns(7);                    //"Video";
                        worksheet.Cells[3, 3].AutoFitColumns(12);                   //"Date";
                        worksheet.Cells[3, 4].AutoFitColumns(20);                   //"Customer Name";
                        worksheet.Cells[3, 5].AutoFitColumns(27);                   //"Company Name";
                        worksheet.Cells[3, 6].AutoFitColumns(12);                   //"Ref No";
                        worksheet.Cells[3, 7].AutoFitColumns(8);                    //"Lab";
                        worksheet.Cells[3, 8].AutoFitColumns(10);                   //"Shape";
                        worksheet.Cells[3, 9].AutoFitColumns(9);                    //"Pointer";
                        worksheet.Cells[3, 10].AutoFitColumns(9);                 //"BGM";
                        ...
                        worksheet.Cells[2, 6].Formula = "ROUND(SUBTOTAL(102," + GetExcelColumnLetter(13) + "" + inStartIndex + ":" + GetExcelColumnLetter(13) + "" + (inwrkrow - 1) + "),2)";
                ...
                else
                {
                    using (ExcelPackage p = new ExcelPackage())
                    {
                        ...
                        worksheet.Cells[3, 5].Value = "Lab";
                        worksheet.Cells[3, 6].Value = "Shape";
                        worksheet.Cells[3, 7].Value = "Pointer";
                        worksheet.Cells[3, 8].Value = "BGM";
                        worksheet.Cells[3, 9].Value = "Color";
                        worksheet.Cells[3, 10].Value = "Clarity";
                        ...
                        worksheet.Cells[3, 20].Value = "Fls";
                        worksheet.Cells[3, 21].Value = "RATIO";
                        worksheet.Cells[3, 22].Value = "Key To Symbol";
                        worksheet.Cells[3, 23].Value = "Length";
                        worksheet.Cells[3, 24].Value = "Width";
                        worksheet.Cells[3, 25].Value = "Depth";
                        worksheet.Cells[3, 26].Value = "Depth (%)";
                        worksheet.Cells[3, 27].Value = "Table (%)";
                        worksheet.Cells[3, 28].Value = "Comment";
                        worksheet.Cells[3, 29].Value = "Girdle(%)";
                        worksheet.Cells[3, 30].Value = "Crown Angle";
                        worksheet.Cells[3, 31].Value = "Crown Height";
                        ...
                        worksheet.Cells[3, 2].AutoFitColumns(7);                //"Video";
                        worksheet.Cells[3, 3].AutoFitColumns(12);               //"Date";
                        worksheet.Cells[3, 4].AutoFitColumns(13);               //"Ref No";
                        worksheet.Cells[3, 5].AutoFitColumns(8);                //"Lab";
                        worksheet.Cells[3, 6].AutoFitColumns(10);               //"Shape";
                        worksheet.Cells[3, 7].AutoFitColumns(9);                //"Pointer";
                        worksheet.Cells[3, 8].AutoFitColumns(9);              //"BGM";
                        worksheet.Cells[3, 9].AutoFitColumns(8);                //"Color";
                        worksheet.Cells[3, 10].AutoFitColumns(8);               //"Clarity";
                        worksheet.Cells[3, 11].AutoFitColumns(8);               //"Cts";
                        worksheet.Cells[3, 12].AutoFitColumns(11);              //"Rap Rate($)";
                        worksheet.Cells[3, 13].AutoFitColumns(11);              //"Rap Amount($)";
                        worksheet.Cells[3, 14].AutoFitColumns(10.5);            //"Final Disc(%)";
                        worksheet.Cells[3, 15].AutoFitColumns(11.5);            //"Final Amt US($)";
                        worksheet.Cells[3, 16].AutoFitColumns(11.5);            //"Price / Cts";
                        worksheet.Cells[3, 17].AutoFitColumns(8);               //"Cut";
                        worksheet.Cells[3, 18].AutoFitColumns(8);               //"Polish";
                        worksheet.Cells[3, 19].AutoFitColumns(8);               //"Symm";
                        worksheet.Cells[3, 20].AutoFitColumns(8);               //"Fls";
                        worksheet.Cells[3, 21].AutoFitColumns(8);               //"RATIO";
                        worksheet.Cells[3, 22].AutoFitColumns(25);              //"Key To Symbol";
                        worksheet.Cells[3, 23].AutoFitColumns(8);             //"Length";
                        worksheet.Cells[3, 24].AutoFitColumns(8);             //"Width";
                        worksheet.Cells[3, 25].AutoFitColumns(8);             //"Depth";
                        worksheet.Cells[3, 26].AutoFitColumns(8);             //"Depth (%)";
                        worksheet.Cells[3, 27].AutoFitColumns(8);             //"Table (%)";
                        worksheet.Cells[3, 28].AutoFitColumns(25);              //"Comment";
                        worksheet.Cells[3, 29].AutoFitColumns(8);               //"Girdle(%)";
                        worksheet.Cells[3, 30].AutoFitColumns(8);               //"Crown Angle";
                        worksheet.Cells[3, 31].AutoFitColumns(8);               //"Crown Height";
                        worksheet.Cells[3, 32].AutoFitColumns(8);               //"Pav Angle";
                        worksheet.Cells[3, 33].AutoFitColumns(8);               //"Pav Height";
                        worksheet.Cells[3, 34].AutoFitColumns(8);             //"Table Black";
                        worksheet.Cells[3, 35].AutoFitColumns(8);             //"Crown Black";
                        worksheet.Cells[3, 36].AutoFitColumns(8);             //"Table White";
                        worksheet.Cells[3, 37].AutoFitColumns(8);             //"Crown White";
                        worksheet.Cells[3, 38].AutoFitColumns(8);               //"Culet";
                        worksheet.Cells[3, 39].AutoFitColumns(8);               //"Table Open";
                        worksheet.Cells[3, 40].AutoFitColumns(8);               //"Crown Open";
                        worksheet.Cells[3, 41].AutoFitColumns(8);               //"Pavilion Open";
                        worksheet.Cells[3, 42].AutoFitColumns(8);               //"Girdle Open";
                        ...
                        for (i = inStartIndex; i < inEndCounter; i++)
                        {
                            ...
                            if (URL != "")
                            {
                                worksheet.Cells[inwrkrow, 5].Formula = "=HYPERLINK(\"" + Convert.ToString(URL) + "\",\" " + Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Lab"]) + " \")";
                                worksheet.Cells[inwrkrow, 5].Style.Font.UnderLine = true;
                                worksheet.Cells[inwrkrow, 5].Style.Font.Color.SetColor(Color.Blue);
                            }


                            worksheet.Cells[inwrkrow, 6].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Shape"]);
                            worksheet.Cells[inwrkrow, 7].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Pointer"]);
                            worksheet.Cells[inwrkrow, 8].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["BGM"]);
                            worksheet.Cells[inwrkrow, 9].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Color"]);
                            worksheet.Cells[inwrkrow, 10].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Clarity"]);
                            ...
                            worksheet.Cells[inwrkrow, 22].Value = Convert.ToString(dtDiamonds.Rows[i - inStartIndex]["Key_To_Symboll"]);
                        ...
                        worksheet.Cells[inStartIndex, 1, (inwrkrow - 1), 42].Style.Font.Size = 9;
                        //worksheet.Cells[inStartIndex, 14, (inwrkrow - 1), 15].Style.Font.Bold = true;
                        ...
                        worksheet.Cells[2, 4].Formula = "ROUND(SUBTOTAL(102," + GetExcelColumnLetter(11) + "" + inStartIndex + ":" + GetExcelColumnLetter(11) + "" + (inwrkrow - 1) + "),2)";
                        ...
                        ExcelStyle cellStyleHeader_TotalRapAmt = worksheet.Cells[2, 13].Style;
                        cellStyleHeader_TotalRapAmt.Border.Left.Style = cellStyleHeader_TotalRapAmt.Border.Right.Style
                                = cellStyleHeader_TotalRapAmt.Border.Top.Style = cellStyleHeader_TotalRapAmt.Border.Bottom.Style
                                = ExcelBorderStyle.Medium;
